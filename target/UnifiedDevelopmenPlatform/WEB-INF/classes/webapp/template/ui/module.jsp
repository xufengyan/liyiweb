...
<form class="layui-form" id="ff">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="id" required  lay-verify="required|number" autocomplete="off" placeholder="请输入【此处需要修改】，要求20位以内的数字" class="layui-input" type="text" maxlength="20">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">名称：</label>
        <div class="layui-input-block">
            <input name="name" required  lay-verify="required" autocomplete="off" placeholder="请输入【此处需要修改】" class="layui-input" type="text">
        </div>
    </div>
     <!--此处可以继续添加表单内容-->
    <div class="layui-form-item">
...
<script>
    ...
    var kb=new KBLayUI("【此处需要修改】控制层模块级访问地址");
