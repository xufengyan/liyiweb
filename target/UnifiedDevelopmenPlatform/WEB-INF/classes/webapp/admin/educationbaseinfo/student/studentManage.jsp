...
<div class="layui-table-tool" id="tb">
    ...
    <input type="text"  style="width: 300px; height: 28px;" name="name" id="txtName" required  placeholder="请输入学生姓名" autocomplete="off"/>
    <div class="layui-btn-group">
...
<table class="easyui-datagrid" title="学生信息管理" style="height:auto" id="dgStudent"
...
<!--导入数据导出-->
<form  style="display: none;"  id="frmDownloadExcel" method="post" action="<%=basePath%>/student/loadout">
     <input type="hidden" id="txtHName" name="name"/>
</form>
<script src="<%=basePath%>/script/business/educationbaseinfo/student.js"></script>
