...
<div data-options="region:'west',split:false,collapsible:true,title:'导航菜单'"
    ...
    <div id="dMyMenu" class="easyui-accordion"  style="width:196px;">
        ...
        <div title="教育基础资源管理" style="width:195px;" class="nav_wj">
            <a href="#"><li class="li_bian" id="college">高校信息管理</li></a>
            <a href="#"><li class="li_bian" id="student">学生信息管理</li></a>
        </div>

        <div title="用户资源管理" style="width:195px;" class="nav_wj">
            <a href="#"><li class="li_bian" id="userInform">用户信息管理</li></a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $(document).on("click","#userInform",function () {
            addTab("用户信息资源管理",getRootPath()+"/userInform/index");
        })
