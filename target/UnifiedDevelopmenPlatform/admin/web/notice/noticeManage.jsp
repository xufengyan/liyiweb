...
<div class="layui-table-tool" id="tb">
    ...
    <input type="text"  style="width: 300px; height: 28px;" name="name" id="txtName" required  placeholder="请输通知的名称" autocomplete="off"/>
...
<table class="easyui-datagrid" title="公告管理" style="height:auto" id="dgNotice"
    ...
    <tr>
        ...
        <th data-options="field:'name',width:180">通知名称</th>
...
<script src="<%=basePath%>/script/business/web/noticeManage.js"></script>
