...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/liyi_sj/Login/css/style.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/liyi_sj/Login/css/animate.css" />

    <script type="text/javascript" src="<%=basePath%>/liyi_sj/Login/js/login.js"></script>
    <script type="text/javascript" src="<%=basePath%>/liyi_sj/Login/js/jquery.min.js"></script>
...
<form id="form1" action="<%=basePath%>/sj_information/useradmin" method="post">
    <div class="LoginWindow">
        <div>
            <div class="login">
                <p><input type="text" name="phone" id="phone" placeholder="用户名" value="${number}"></p>
                <p><input type="password" name="password" id="password" placeholder="密码" value="${password}"></p>
