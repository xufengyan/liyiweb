...
<table class="easyui-datagrid" title="投诉信息管理" style="height:auto" id="dgCompaints"
    ...
    <tr>
        ...
        <th data-options="field:'complaintstime',width:100,formatter: Date.prototype.getShortDate ">投诉时间</th>
...
<!--导入数据导出-->
<form  style="display: none;"  id="frmDownloadExcel" method="post" action="<%=basePath%>/compaints/loadout">
...
<script src="<%=basePath%>/script/business/educationbaseinfo/compaints.js"></script>
