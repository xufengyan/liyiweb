...
<body>
    <div class="layui-table-tool" id="tb">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="name" id="txtName" required  placeholder="请输入订单编号" autocomplete="off">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">下单时间:</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" id="test1" placeholder="请选择下单时间">
            </div>
        </div>
        <div class="layui-btn-group">
            <button class="layui-btn layui-btn-small" style="background-color: #008AE5;" id="btnFind">
                <i class="layui-icon">&#xe615;</i>查询
            </button>
        </div>
        <button class="layui-btn layui-btn-small" style="background-color: #008AE5;" id="btnDownLoad" >
            <i class="layui-icon">&#xe61e;</i>导出
        </button>
    </div>
    <table class="easyui-datagrid" title="未发货订单管理" style="height:auto;" id="dgUnshipped"
    ...
    <!--导入数据导出-->
    <form  style="display: none;"  id="frmDownloadExcel" method="post" action="<%=basePath%>/business/loadout">
    ...
    <script>
        ...
        var dataSheet="dgUnshipped";
        function getCondition(statue) {
            var obj = new Object();
            obj.condition=statue;
            obj.ordertime = $("#test1").val();
