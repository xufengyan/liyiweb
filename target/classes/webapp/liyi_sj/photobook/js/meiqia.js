!function(t) {
	...
	window._MEIQIA_KNOCKOFF || !
	function() {
		window._MEIQIA_KNOCKOFF = !0;
		var t = A["default"]();
		h["default"].entId = t.entId, h["default"].manualInit = t.manualInit, h["default"].withoutBtn = t.withoutBtn, h["default"].fallback = t.fallback, h["default"].allSet = t.allSet, 
		h["default"].convClickCallback = t.convClickCallback, h["default"].startConversation = t.startConversation, 
		h["default"].endConversation =  t.endConversation, h["default"].getInviting = t.getInviting, 
		h["default"].getPanelVisibility =  t.getPanelVisibility, h["default"].getUnreadMsg = t.getUnreadMsg, 
		h["default"].metadata = t.metadata, h["default"].assign = t.assign, h["default"].clientId = t.clientId, 
		h["default"].disableBrandLink =  t.disableBrandLink, h["default"].language = t.language ? t.language : "zh", 
		h["default"].entId && (h["default"].messenger =  new a["default"]("parent", "MEIQIA-ECOBOOST"), W["default"](), et.InitBlacklist().then(function() {
			...
			case "cookies":
				...
				h["default"].trackId = i.trackId || b["default"]("get", "MEIQIA_EXTRA_TRACK_ID") || g["default"].get("MEIQIA_EXTRA_TRACK_ID"), h["default"].panelVisibility =
				i.panelVisibility, i.trackId && (h["default"].history = !0), z["default"](), h["default"].clientId ? Y["default"].getBinding() : x["default"]();
				break;
			case "chatReady":
				...
				if (h["default"].trackId && o) {
					...
					h["default"].messenger.addTarget(o.contentWindow, "iframe1"), h["default"].messenger.targets.iframe1.send("startUp^@#" + JSON.stringify(r)), 
					"function" == typeof h["default"].getInviting && h["default"].initData.servability && 2 === h["default"].initData.visitor_status 
					&& C["default"](h["default"].initData.visitor_status_agent_token), 
					document.getElementById("MEIQIA-BTN-HOLDER") && (document.getElementById("MEIQIA-BTN-HOLDER").style.display = 
					"block");
					var a = {
						agentToken: null,
						groupToken: null,
					...
					h["default"].assign && (h["default"].assign.agentToken && (a.agentToken = 
						h["default"].assign.agentToken), h["default"].assign.groupToken && (a.groupToken = h["default"].assign.groupToken)), h["default"].initData.servability && 4 === h["default"].initData.visitor_status 
			...
			case "unreadMsg":
				if ("null" !== e[1] && "false" !== e[1] && h["default"].initData.servability && "invisible" === h["default"].panelVisibility) {
					...
					P["default"](s), N["default"](s)
				}
				break;
			case "hidePanel":
				l["default"].isMobile() && history.pushState && history.state && history.state.MQ && !l["default"].isSafari() ? 
				(history.go(-1), h["default"].messenger.targets.iframe1.send("panelVisibility^@#invisible")) : (L["default"]("hide"),R["default"]());
				break;
			case "showPanel":
			...
			case "newMsg":
				if ("invisible" === h["default"].panelVisibility) {
					...
					h["default"].messenger.targets.iframe1.send("handleUnread^@#" + JSON.stringify(p)), N["default"](e[1])
				}
				break;
			case "inviting":
				h["default"].initData.servability && ("function" == typeof h["default"].getInviting ? C["default"](e[1]) : (h["default"].agentToken = e[1], h["default"].inviteType = "manual", V["default"](), 
				h["default"].messenger.targets.iframe1.send("ringing^@#newChat")));
				break;
			case "pinScroll":
	...
	var i, o, r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
	function(t) {
		return typeof t
	} : function(t) {
		return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
	...
	function(r, a) {
		...
		var t, e, n = Array,
			...
			O = "[object RegExp]";
		e = function(t) {
			return "object" !== ("undefined" == typeof t ? "undefined" : r(t)) ? !1 : A ? C(t) : _.call(t) === O
		};
		var L, S = String.prototype.valueOf,
			...
			j = "[object String]";
		L = function(t) {
			return "string" == typeof t ? !0 : "object" !== ("undefined" == typeof t ? "undefined" : r(t)) ? !1 : A ? R(t) : _.call(t) === j
		};
		var V = o.defineProperty &&
		function() {
			try {
				var t = {};
		...
		U(i, {
			...
			every: function(e) {
				...
				for (var a = 0; r > a; a++) if (a in o && !("undefined" == typeof n ? e(o[a], a, i) : e.call(n, o[a], a, i))) return !1;
				return !0
			}
		}, !ot(i.every)), U(i, {
			some: function(e) {
				...
				for (var a = 0; r > a; a++) if (a in o && ("undefined" == typeof n ? e(o[a], a, i) : e.call(n, o[a], a, i))) return !0;
				return !1
			}
		}, !ot(i.some));
		var rt = !1;
		...
		U(i, {
			indexOf: function(t) {
				...
				if (0 === n) return -1;
				var i = 0;
				for (arguments.length > 1 && (i = D.ToInteger(arguments[1])), i = i >= 0 ? i : v(0, n + i); n > i; i++) if (i in e && e[i] === t) return i;
				return -1
			}
		}, st);
		...
		U(i, {
			lastIndexOf: function(t) {
				...
				if (0 === n) return -1;
				var i = n - 1;
				for (arguments.length > 1 && (i = x(i, D.ToInteger(arguments[1]))), i = i >= 0 ? i : n - Math.abs(i); i >= 0; i--) if (i in e && t === e[i]) return i;
				return -1
			}
		}, lt);
		var ut = function() {
		...
		U(i, {
			splice: function(t, e) {
				for (var n, i = D.ToObject(this), o = [], r = D.ToUint32(i.length), a = D.ToInteger(t), s = 0 > a ? v(r + a, 0) : x(a, r), l = x(v(D.ToInteger(e), 0), r - s), c = 0; l > c;) n = u(s + c), z(i, n) && (o[c] = i[n]), c += 1;
				...
				} else if (f > l) for (c = r - l; c > s;) n = u(c + l - 1), p = u(c + f - 1), z(i, n) ? i[p] = i[n] : delete i[p], c -= 1;
				c = s;
		...
		U(o, {
			keys: function(e) {
				...
				var s = [],
					l = At && n;
				if (a && Tt || i) for (var c = 0; c < e.length; ++c) X(s, u(c));
				if (!i) for (var p in e) l && "prototype" === p || !z(e, p) || X(s, u(p));
				if (_t) for (var d = Qt(e), f = 0; kt > f; f++) {
					var h = Nt[f];
		...
		var Vt, Ut, Pt = 0 !== new Date(-0xc782b5b342b24).getUTCMonth(),
			...
			zt = Ft.getTimezoneOffset(); - 720 > zt ? (Vt = "Tue Jan 02 -45875" !== Ft.toDateString(), Ut = !/^Thu Dec 10 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(Dt.toString())) :(Vt = "Mon Jan 01 -45875" !== Ft.toDateString(), 
			Ut = !/^Wed Dec 09 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(Dt.toString()));
		...
		U(Date.prototype, {
			...
			return ne[t] + " " + ie[n] + " " + (10 > e ? "0" + e : e) + " " + i + " " + (10 > o ? "0" + o : o) + ":" + (10 > r ? "0" + r : r) + 
			":" + (10 > a ? "0" + a : a) + " GMT" + (s > 0 ? "-" : "+") + (10 > l ? "0" + l : l) + (10 > u ? "0" + u : u)
			...
			Date = function(t) {
				var e = function(n, i, o, r, a, s, l) {
						...
						if (this instanceof t) {
							...
							c = 1 === p && u(n) === n ? new t(e.parse(n)) : p >= 7 ? new t(n, i, o, r, a, d, f) : p >= 6 ? 
							new t(n, i, o, r, a, d) : p >= 5 ? new t(n, i, o, r, a) : p >= 4 ? new t(n, i, o, r) : p >= 3 ? 
							new t(n, i, o) : p >= 2 ? new t(n, i) : p >= 1 ? new t(n instanceof t ? +n : n) : new t
				...
				var s = function(e) {
						...
						if (i) {
							var a, s = p(i[1]),
								...
								b = p(i[11] || 0),
								E = d > 0 || f > 0 || h > 0;
							return (E ? 24 : 25) > c && 60 > d && 60 > f && 1e3 > h && l > -1 && 12 > l && 24 > m && 60 > b && u > -1 && u < o(s, l + 1) - o(s, l) 
							&& (a = 60 * (24 * (o(s, l) + u) + c + m * g), a = 1e3 * (60 * (a + d + b * g) + f) + h, I && (a = r(a)), a >= -864e13 && 864e13 >= a) ? a : 0 / 0
						}
		...
		var ge = d.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
			...
			be = function(t) {
				...
				if (i = "", 0 > n && (i = "-", n = -n), o = "0", n > 1e-21) if (r = me.log(n * me.pow(2, 69, 1)) - 69, a = 0 > r ? n * me.pow(2, -r, 1) : n / me.pow(2, r, 1), a *= 4503599627370496, r = 52 - r, r > 0) {
		...
		}, Ee), 2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? !
		function() {
			var t = "undefined" == typeof / () ? ? /.exec("")[1],n=Math.pow(2,32)-1;c.split=function(i,o){var r=String(this);if("undefined"==typeof i&&0===o)return[];if(!e(i))return q(this,i,o);
			var a,s,l,u,c=[],p=(i.ignoreCase?"i":"")+(i.multiline?"m":"")+(i.unicode?"u":"")+(i.sticky?"y":""),d=0,f=new RegExp(i.source,p+"g");
				t||(a=new RegExp("^"+f.source+"$(?!\\s)",p));var h="undefined"==typeof o?n:D.ToUint32(o);
				for(s=f.exec(r);s&&(l=s.index+s[0].length,!(l>d&&(X(c,Y(r,d,s.index)),
				!t&&s.length>1&&s[0].replace(a,function(){for(var t=1;t<arguments.length-2;t++)"undefined"==typeof arguments[t]&&(s[t]=void 0)}),
				s.length>1&&s.index<r.length&&I.apply(c,W(s,1)),u=s[0].length,d=l,c.length>=h)));)f.lastIndex===s.index&&f.lastIndex++,s=f.exec(r);
				return d===r.length?(u||!f.test(""))&&X(c,""):X(c,Y(r,d)),c.length>h?W(c,0,h):c}}():"0".split(void 0,0).length&&(c.split=function(t,e){return"undefined"==typeof t&&0===e?[]:q(this,t,e)});
				var ve=c.replace,xe=function(){var t=[];return"x".replace(/x (.) ? /g,function(e,n){X(t,n)}),1===t.length&&"undefined"==typeof t[0]}();xe||(c.replace=function(n,i){var o=t(i),r=e(n)&&/\)[ * ? ] / .test(n.source);
		if (o && r) {
			var a = function(t) {
	...
	U(c, {
		substr: function(t, e) {
			var n = t;
			return 0 > t && (n = v(this.length + t, 0)), _e.call(this, n, e)
		}
	}, Ae);
	var Te = "	\n\f\r   ᠎             　\u2028\u2029\ufeff",
		Me = "​",
		...
		Be = new RegExp("^" + we + we + "*"),
		Qe = new RegExp(we + we + "*$"),
		Ne = c.trim && (Te.trim() || !Me.trim());
	U(c, {
		trim: function() {
			if ("undefined" == typeof this || null === this) throw new TypeError("can't convert " + this + " to object");
			return u(this).replace(Be, "").replace(Qe, "")
		}
	}, Ne);
	var ke = E.bind(String.prototype.trim),
		Ce = c.lastIndexOf && -1 !== "abcあい".lastIndexOf("あい", 2);
	U(c, {
		lastIndexOf: function(t) {
			if ("undefined" == typeof this || null === this) throw new TypeError("can't convert " + this + " to object");
			for (var e = u(this), n = u(t), i = arguments.length > 1 ? p(arguments[1]) : 0 / 0, o = F(i) ? 1 / 0 : D.ToInteger(i), r = x(v(o, 0), e.length), a = n.length, s = r + a; s > 0;) {
				s = v(0, s - a);
				var l = J(Y(e, s, r + a), n);
				if (-1 !== l) return s + l
			}
	...
	function(r, a) {
		...
		if (!Object.getOwnPropertyDescriptor || I) {
			...
			Object.getOwnPropertyDescriptor = function(t, e) {
				...
				if (r = {
					...
					var f = n(t, e),
						h = i(t, e);
					if (d && (t.__proto__ = u), f || h) return f && (r.get = f), h && (r.set = h), r
				}
		...
		if (Object.defineProperty) {
			var _ = x({}),
				A = "undefined" == typeof document || x(document.createElement("div"));
			if (!_ || !A) var T = Object.defineProperty,
		...
		if (!Object.defineProperty || T) {
			...
			Object.defineProperty = function(o, r, s) {
				...
				if ("value" in s) if (c && (n(o, r) || i(o, r))) {
					var u = o.__proto__;
					...
					var d = "get" in s,
						f = "set" in s;
					if (!c && (d || f)) throw new TypeError(Q);
			...
			function a(t, e) {
							...
							if (c) {
								...
								try {
									c = "0" === l(0) && "0" === l(new i) && '""' == l(new o) && l(E) === m && l(m) === m && l() === m && "1" === l(a) && "[1]" == l([a]) && "[null]" == l([m]) && "null" == l(null) && "[null,null,null]" == l([m, E, null]) && l({
										a: [a, !0, !1, null, "\x00\b\n\f\r	"]
									}) == s && "1" === l(null, a) && "[\n 1,\n 2\n]" == l([1, 2], null, 1) && '"-271821-04-20T00:00:00.000Z"' == l(new u(-864e13)) && '"+275760-09-13T00:00:00.000Z"' == l(new u(864e13)) && '"-000001-01-01T00:00:00.000Z"' == 
									l(new u(-621987552e5)) && '"1969-12-31T23:59:59.999Z"' == l(new u(-1))
								} catch (p) {
									c = !1
								}
							}
				...
				if (!n("json")) {
					...
					if (!y) var Q = f.floor,
						...
						k = function(t, e) {
							return N[e] + 365 * (t - 1970) + Q((t - 1969 + (e = +(e > 1))) / 4) - Q((t - 1901 + e) / 100) + Q((t - 1601 + e) / 400)
						};
					if ((I = b.hasOwnProperty) || (I = function(t) {
						...
						var C = {
							...
							j = function G(t, e, n, i, o, a, s) {
								var l, u, c, p, f, h, b, y, v, x, B, N, C, O, S, j;
								try {
									l = e[t]
								} catch (V) {}
								if ("object" == ("undefined" == typeof l ? "undefined" : r(l)) && l) if (u = E.call(l), u != _ || I.call(l, "toJSON"))"function" == typeof l.toJSON && (u != A && u != T && u != M || I.call(l, "toJSON")) && (l = l.toJSON(t));
								else if (l > -1 / 0 && 1 / 0 > l) {
									if (k) {
										for (f = Q(l / 864e5), c = Q(f / 365.2425) + 1970 - 1; k(c + 1, 0) <= f; c++);
										for (p = Q((f - k(c, 0)) / 30.42); k(c, p + 1) <= f; p++);
										f = 1 + f - k(c, p), h = (l % 864e5 + 864e5) % 864e5, b = Q(h / 36e5) % 24, y = Q(h / 6e4) % 60, v = Q(h / 1e3) % 60, x = h % 1e3
									} else c = l.getUTCFullYear(), p = l.getUTCMonth(), f = l.getUTCDate(), b = l.getUTCHours(), y = l.getUTCMinutes(), v = l.getUTCSeconds(), x = l.getUTCMilliseconds();
									l = (0 >= c || c >= 1e4 ? (0 > c ? "-" : "+") + L(6, 0 > c ? -c : c) : L(4, c)) + "-" + L(2, p + 1) + "-" + L(2, f) + "T" + L(2, b) + ":" + L(2, y) + ":" + L(2, v) + "." + L(3, x) + "Z"
								} else l = null;
								...
								if ("object" == ("undefined" == typeof l ? "undefined" : r(l))) {
									for (O = s.length; O--;) if (s[O] === l) throw d();
									if (s.push(l), B = [], S = a, a += o, u == M) {
										for (C = 0, O = l.length; O > C; C++) N = G(C, l, n, i, o, a, s), B.push(N === m ? "null" : N);
										j = B.length ? o ? "[\n" + a + B.join(",\n" + a) + "\n" + S + "]" : "[" + B.join(",") + "]" : "[]"
					...
					if (!n("json-parse")) {
						var V, U, P = o.fromCharCode,
							...
							H = function() {
								...
								case 34:
									for (t = "@", V++; a > V;) if (o = r.charCodeAt(V), 32 > o) D();
							...
							W = function(t, e, n) {
								var i, o = t[e];
								if ("object" == ("undefined" == typeof o ? "undefined" : r(o)) && o) if (E.call(o) == M) for (i = o.length; i--;) $(o, i, n);
								else g(o, function(t) {
									$(o, t, n)
								});
								return n.call(t, e, o)
						...
						e.parse = function(t, e) {
							var n, i;
							return V = 0, U = "" + t, n = z(H()), "$" != H() && D(), V = U = null, e && E.call(e) == x ? W((i = {}, i[""] = n, i), "", e) : n
						}
					}
				}
	...
	function(t, e, n) {
		if ((!t.addEventListener || !t.removeEventListener) && t.attachEvent && t.detachEvent) {
			var i = function(t) {
				...
				o = function(t, e) {
					var i = e[n];
					if (i) for (var o, r = i.length; r--;) if (o = i[r], o[0] === t) return o[1]
				},
				r = function(t, e, i) {
					var r = e[n] || (e[n] = []);
				...
				s = function(n, o) {
					if (i(o)) {
						...
						a.attachEvent("on" + n, r(a, o, function(n) {
							n = n || t.event, n.preventDefault = n.preventDefault ||
							function() {
								n.returnValue = !1
				...
				u = function(t) {
					if (t) {
						var e = t.length;
						if (e) for (; e--;) t[e].addEventListener = s, t[e].removeEventListener = l;
	...
	function n(t, e) {
		var n = "";
		if (arguments.length < 2 ? n = "target error - target and name are both required" : "object" != ("undefined" == typeof t ? "undefined" : o(t)) ? 
		n = "target error - target itself must be window object" : "string" != typeof e && (n = "target error - target name must be string type"), n)throw new Error(n);
	...
	function(t) {
		...
		return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
	}, r = "[PROJECT_NAME]", a = "postMessage" in window;
	n.prototype.send = a ?
	function(t) {
	...
	Object.defineProperty(e, "__esModule", {
		...
		isMobile: function n() {
			...
			return (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(t)
	...
	Object.defineProperty(e, "__esModule", {
		...
		document.getElementById("MEIQIA-DOORBELL-HOLDER") && document.body.removeChild(document.getElementById("MEIQIA-DOORBELL-HOLDER")), document.getElementById("MEIQIA-PANEL-HOLDER") 
		&& document.getElementById("MEIQIA-PANEL-HOLDER").parentNode.removeChild(document.getElementById("MEIQIA-PANEL-HOLDER")), document.getElementById("MEIQIA-BTN-HOLDER") 
		&& document.getElementById("MEIQIA-BTN-HOLDER").parentNode.removeChild(document.getElementById("MEIQIA-BTN-HOLDER")), document.getElementById("MEIQIA-INVITE") 
		&& document.getElementById("MEIQIA-INVITE").parentNode.removeChild(document.getElementById("MEIQIA-INVITE")), document.getElementById("MEIQIA-PANEL-STYLE")
		&& document.getElementById("MEIQIA-PANEL-STYLE").parentNode.removeChild(document.getElementById("MEIQIA-PANEL-STYLE")), document.getElementById("MEIQIA-BTN-STYLE") 
		&& document.getElementById("MEIQIA-BTN-STYLE").parentNode.removeChild(document.getElementById("MEIQIA-BTN-STYLE")), document.getElementById("MEIQIA-INVITE-STYLE") 
		&& document.getElementById("MEIQIA-INVITE-STYLE").parentNode.removeChild(document.getElementById("MEIQIA-INVITE-STYLE")), document.getElementById("MEIQIA-ICON-STYLE") 
		&& document.getElementById("MEIQIA-ICON-STYLE").parentNode.removeChild(document.getElementById("MEIQIA-ICON-STYLE"))
	}
}, function(t, e, n) {
	"use strict";
			...
			success: function(t) {
				if (t.success && !t.black) {
					...
					e.setTime(e.getTime() + 6048e5), f["default"].set("MEIQIA_VISIT_ID", t.visit_id, {
						...
						expires: 1 / 0
					}), I["default"]("set", "MEIQIA_EXTRA_TRACK_ID", E["default"].trackId), E["default"].clientId && !E["default"].clientBind && O["default"].getBinding(), E["default"].initData = t, E["default"].assign 
						&& (E["default"].initData.agentTokens = E["default"].assign.agentToken);
					var n = m["default"]("icon-css", {
						cdn: r["default"].cdn,
						tail: r["default"].tail
					});
					s["default"].isMobile() ? (E["default"].panelVisibility = "invisible", Q["default"]("invisible"), v["default"]("init"), ("round" === t.widget_settings.mobile.btn.type || "call" === t.widget_settings.mobile.btn.type)
					&& (n = m["default"]("icon-round-css", {
						cdn: r["default"].cdn,
						tail: r["default"].tail
					}))) : (4 === t.visitor_status || t.in_queue || (E["default"].panelVisibility = "invisible", Q["default"]("invisible")), ("round" === t.widget_settings.desktop.btn.type || "call" === t.widget_settings.desktop.btn.type) 
					&& (n = m["default"]("icon-round-css", {
						cdn: r["default"].cdn,
						tail: r["default"].tail
					}))), u["default"](n, "MEIQIA-ICON-STYLE"), _["default"](), E["default"].withoutBtn || T["default"](), "function" != typeof E["default"].getInviting && w["default"](), E["default"].metadata && k["default"]()
				}
			}
		})
	}
	...
	var o = function(t, e) {
		...
		r = function(t) {
			...
			else for (var r = ["Microsoft.XmlHttp", "MSXML2.XmlHttp", "MSXML2.XmlHttp.3.0", "MSXML2.XmlHttp.4.0", "MSXML2.XmlHttp.5.0", "MSXML2.XmlHttp.6.0"], a = 0, s = r.length; s > a; a++) try {
			...
			if (n.onreadystatechange = function() {
				...
				var u = t.header;
				if (u) for (var c in u) n.setRequestHeader(c, u[c]);
				var p = t.data;
	...
	function() {
		...
		function u(t, e) {
			if (m(t)) for (var n = 0, i = t.length; i > n; n++) e.call(t, t[n], n, t);
		...
		r.get = function(t) {
			...
			return r
		}.call(e, n, e, t), !(void 0 !== i && (t.exports = i)), r("btn-aside", function(t) {
			"use strict";
			var e = this,
			...
			return r += '<div id="MEIQIA-BTN"> <span id="MEIQIA-BTN-ICON" class="MEIQIA-ICON MEIQIA-ICON-', 
					r += n(i), r += '"></span> <span id="MEIQIA-BTN-LINE"></span> <span id="MEIQIA-BTN-TEXT">',
					r += n(o), r += '</span> <span id="MEIQIA-CIRCLE"></span> <div id="MEIQIA-BUBBLE"> <span id="MEIQIA-BUBBLE-ARROW1"></span> <span id="MEIQIA-BUBBLE-ARROW2"></span> <span id="MEIQIA-BUBBLE-CLOSE" class="MEIQIA-ICON"></span> <div id="MEIQIA-BUBBLE-INSIDE"> <img id="MEIQIA-BUBBLE-AVATAR" /> <span id="MEIQIA-BUBBLE-NAME"></span> <div id="MEIQIA-BUBBLE-MSG"></div> </div> </div> </div>', 
					new I(r)
			...
			o += n(i), o += '"></span> <span id="MEIQIA-CIRCLE"></span> <div id="MEIQIA-BUBBLE"> <span id="MEIQIA-BUBBLE-ARROW1"></span> <span id="MEIQIA-BUBBLE-ARROW2"></span> <span id="MEIQIA-BUBBLE-CLOSE" class="MEIQIA-ICON"></span> <div id="MEIQIA-BUBBLE-INSIDE"> <img id="MEIQIA-BUBBLE-AVATAR" /> <span id="MEIQIA-BUBBLE-NAME"></span> <div id="MEIQIA-BUBBLE-MSG"></div> </div> </div> </a>',
			new I(o)
			...
			return o += '<div id="MEIQIA-BTN"> <img id="MEIQIA-BTN-PICTURE" src="', 
					o += n(i), o += '" /> <span id="MEIQIA-CIRCLE"></span> <div id="MEIQIA-BUBBLE"> <span id="MEIQIA-BUBBLE-ARROW1"></span> <span id="MEIQIA-BUBBLE-ARROW2"></span> <span id="MEIQIA-BUBBLE-CLOSE" class="MEIQIA-ICON"></span> <div id="MEIQIA-BUBBLE-INSIDE"> <img id="MEIQIA-BUBBLE-AVATAR" /> <span id="MEIQIA-BUBBLE-NAME"></span> <div id="MEIQIA-BUBBLE-MSG"></div> </div> </div> </div>', 
					new I(o)
			...
			var e = this,
				...
				i = t.popupText,
				o = "";
			return o += '<span id="MEIQIA-INVITE-CLOSE" class="MEIQIA-ICON"></span> <div id="MEIQIA-INVITE-INSIDE">', o += n(i), o += '</div> <span id="MEIQIA-INVITE-ARROW1"></span> <span ID="MEIQIA-INVITE-ARROW2"></span>',
			new I(o)
			...
			var e = this,
				...
				i = t.popupText,
				o = "";
			return o += '<span id="MEIQIA-INVITE-CLOSE" class="MEIQIA-ICON"></span> <div id="MEIQIA-INVITE-INSIDE">', o += n(i), o += "</div>", new I(o)
			...
			var e = this,
				...
				i = t.src,
				o = "";
			return o += '<span id="MEIQIA-INVITE-CLOSE" class="MEIQIA-ICON"></span> <div id="MEIQIA-INVITE-INSIDE"> <img src="', o += n(i), o += '"> </div>', new I(o)
			...
			var e = this,
				...
				r = t.actions,
				a = (t.v, t.k, "");
			return a += '<img src="', a += n(i.src), a += '" id="MEIQIA-INVITE-BG"> <div id="MEIQIA-INVITE-ACTIONS"> ', o(r, function(t, e) {
				a += " ", 1 === t.type ? (a += '  <a id="MEIQIA-INVITE-ACTION-', a += n(e), a += '" href="javascript:void(0);" name="meiqiaInviteAccept"></a> ') : 2 === t.type 
										? (a += '  <a id="MEIQIA-INVITE-ACTION-', a += n(e), a += '" href="javascript:void(0);" name="meiqiaInviteReject"></a> ') : 3 === t.type   
										&& (a += "  ", 1 === t.linkType ? (a += '  <a id="MEIQIA-INVITE-ACTION-', a += n(e), a += '" href="', a += n(t.href), a += '" target="_blank"></a> ') : 2 === t.linkType 
										? (a += '  <a id="MEIQIA-INVITE-ACTION-', a += n(e), a += '" href="mailto:', a += n(t.href), a += '"></a> ') : 3 === t.linkType 
										&& (a += '  <a id="MEIQIA-INVITE-ACTION-', a += n(e), a += '" href="tel:', a += n(t.href), a += '"></a> '), a += " "), a += " "
			}), a += " </div> ", new I(a)
			...
			var e = this,
				...
				i = t.pageSrc,
				o = "";
			return o += '<div id="MEIQIA-DRAG-HANDLE"></div> <div id="MEIQIA-DRAG-MASK"></div> <iframe id="MEIQIA-IFRAME" src="', o += n(i), o += '" frameborder="0" scrolling="no" allowtransparency="true"></iframe> ', 
			new I(o)
			...
			var e = this,
				...
				i = t.pageSrc,
				o = "";
			return o += '<iframe id="MEIQIA-IFRAME" src="', o += n(i), o += '" frameborder="0" scrolling="no" allowtransparency="true"></iframe> ', new I(o)
			...
			var e = this,
				...
				r = t.bgColor,
				a = "";
			return a += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: ", a += n(i.bottom), a += "px; ", a += "left" === i.type ? " left: 0; " : " right: 0; ", 
					a += " z-index: 2147483647; width: auto; height: auto; padding: 0; margin: 0; border: 0; font-family: 'Helvetica Neue', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif; background-color: transparent; } #MEIQIA-BTN, #MEIQIA-BTN span, #MEIQIA-BTN div, #MEIQIA-BTN img { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-BTN { display: block; width: 40px; height: auto; max-height: 90vh; padding: 10px 0; font-size: 16px; color: ", 
					a += n(o), a += "; text-align: center; border-top: 1px solid rgba(0, 0, 0, .1); border-bottom: 1px solid rgba(0, 0, 0, .1); box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); cursor: pointer; text-decoration: none; background-color: ",
					a += n(r), a += "; } #MEIQIA-BTN #MEIQIA-BTN-ICON { display: block; width: 20px; height: 20px; margin: 0 10px 10px; } #MEIQIA-BTN #MEIQIA-BTN-LINE { display: inline-block; width: 100%; height: 1px; background-color: rgba(0, 0, 0, .08); 
						background-color: #000\\9; opacity: .1\\9; filter: alpha(opacity=10)\\9; vertical-align: middle; } 
						#MEIQIA-BTN #MEIQIA-BTN-TEXT { display: block; box-sizing: content-box; max-height: 80%; padding: 0 10px; margin-top: 10px; text-align: center; overflow: hidden; line-height: 1.428571429; 
							font-size: 16px; color: ", a += n(o), a += "; word-break: break-all; word-wrap: break-word; letter-spacing: 5px; *width: 16px; *letter-spacing: 5px; -webkit-writing-mode: vertical-rl; 
							writing-mode: vertical-rl; white-space: nowrap; text-overflow: ellipsis; } 
							#MEIQIA-BTN #MEIQIA-CIRCLE { position: absolute; display: none; width: 26px; height: 26px; text-align: center; line-height: 26px; font-size: 14px; 
								color: #fff; border-radius: 15px; background-color: #ff3b30; } 
								#MEIQIA-BTN #MEIQIA-BUBBLE { position: absolute; bottom: 40%; display: none; width: 260px; border: 1px solid #f7f7f7; border-radius: 4px; color: #000; 
									text-align: left; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { position: absolute; z-index: 2; font-size: 0; line-height: 0; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { position: absolute; z-index: 1; font-size: 0; line-height: 0; } ", a += "left" === i.type ? " 
									#MEIQIA-BTN{ border-right: 1px solid rgba(0, 0, 0, .1); } 
									#MEIQIA-BTN #MEIQIA-CIRCLE { top: -13px; right: -13px; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE { left: 60px; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { left: -8px; top: 20px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-right: 8px solid #fff; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { left: -10px; top: 19px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-right: 9px solid #f7f7f7; } " : " 
									#MEIQIA-BTN { border-left: 1px solid rgba(0, 0, 0, .1); } 
									#MEIQIA-BTN #MEIQIA-CIRCLE { top: -13px; left: -13px; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE { right: 60px; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { right: -8px; top: 20px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-left: 8px solid #fff; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { right: -10px; top: 19px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-left: 9px solid #f7f7f7; } ", a += " 
									#MEIQIA-BTN #MEIQIA-BUBBLE-CLOSE { position: absolute; display: none; top: 12px; right: 12px; width: 10px; height: 10px; background-position: -5px -245px; cursor: pointer; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE:hover #MEIQIA-BUBBLE-CLOSE { display: block; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-INSIDE { margin: 12px 18px; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-MSG { *height: 40px; max-height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; } 
									#MEIQIA-BTN #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(a)
			...
			var e = this,
				...
				r = t.bgColor,
				a = "";
			return a += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: 0; ", "left" === n.type ? (a += " left: ", a += i(n.horizontal), a += "px; ") : (a += " right: ", a += i(n.horizontal), a += "px; "), 
					a += " z-index: 2147483647; width: auto; height: auto; padding: 0; margin: 0; border: 0; font-family: 'Helvetica Neue', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif; background-color: transparent; } 
					#MEIQIA-BTN, #MEIQIA-BTN span, #MEIQIA-BTN div, #MEIQIA-BTN img { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } 
					#MEIQIA-BTN { display: block; height: 40px; font-size: 16px; color: ", a += i(o), a += "; text-align: center; border-left: 1px solid rgba(0, 0, 0, .1); border-top: 1px solid rgba(0, 0, 0, .1); 
						border-right: 1px solid rgba(0, 0, 0, .1); box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); cursor: pointer; text-decoration: none; background-color: ", a += i(r), a += "; } 
					#MEIQIA-BTN #MEIQIA-BTN-ICON { display: block; float: left; width: 20px; height: 20px; margin: 10px 10px 0; } 
					#MEIQIA-BTN #MEIQIA-BTN-LINE { display: block; float: left; width: 1px; height: 100%; background-color: rgba(0, 0, 0, .08); background-color: #000\\9; opacity: .1\\9; filter: alpha(opacity=10)\\9; vertical-align: middle; } 
					#MEIQIA-BTN #MEIQIA-BTN-TEXT { display: block; float: left; height: 40px; margin: 0 10px; line-height: 40px; overflow-y: hidden; font-size: 16px; color: ", a += i(o), a += "; } 
					#MEIQIA-BTN #MEIQIA-CIRCLE { position: absolute; top: -13px; left: -13px; display: none; width: 26px; height: 26px; 
						text-align: center; line-height: 26px; font-size: 14px; color: #fff; border-radius: 15px; background-color: #ff3b30; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE { position: absolute; bottom: 64px; display: none; width: 260px; border: 1px solid #f7f7f7; border-radius: 4px; color: #000; text-align: left; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { position: absolute; z-index: 2; font-size: 0; line-height: 0; border-width: 8px 7px 0px; border-color: #fff transparent; border-style: solid dashed dashed; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { position: absolute; z-index: 1; font-size: 0; line-height: 0; border-width: 10px 8px 0px; border-color: #f7f7f7 transparent; border-style: solid dashed dashed; } ", 
					a += "left" === n.type ? " 
					#MEIQIA-BTN #MEIQIA-BUBBLE { left: 0; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { left: 12px; bottom: -8px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { left: 11px; bottom: -10px; } " : " #MEIQIA-BTN #MEIQIA-BUBBLE { right: 0; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { right: 12px; bottom: -8px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { right: 11px; bottom: -10px; } ", a += " #MEIQIA-BTN #MEIQIA-BUBBLE-CLOSE { position: absolute; display: none; top: 12px; right: 12px; width: 10px; height: 10px; background-position: -5px -245px; cursor: pointer; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE:hover #MEIQIA-BUBBLE-CLOSE { display: block; } #MEIQIA-BTN #MEIQIA-BUBBLE-INSIDE { margin: 12px 18px; } #MEIQIA-BTN #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; } #MEIQIA-BTN #MEIQIA-BUBBLE-MSG { *height: 40px; max-height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(a)
			...
			var e = this,
				...
				o = t.bgColor,
				r = "";
			return r += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: ", r += n(i.bottom), r += "px; ", "left" === i.type ? (r += " left: ", r += n(i.horizontal), r += "px; ") : (r += " right: ", r += n(i.horizontal), r += "px; "), 
					r += " z-index: 2147483647; width: auto; height: auto; padding: 0; margin: 0; border: 0; font-family: 'Helvetica Neue', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif; background-color: transparent; } 
					#MEIQIA-BTN-CALL, #MEIQIA-BTN-CALL span, #MEIQIA-BTN-CHAT, #MEIQIA-BTN-CHAT span, #MEIQIA-BTN-CHAT div, #MEIQIA-BTN-CHAT img { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } 
					#MEIQIA-BTN-CALL { display: block; position: relative; width: 60px; height: 60px; border: 1px solid rgba(0, 0, 0, .1); border-radius: 31px; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); cursor: pointer; text-decoration: none; background-color: ", r += n(o), r += "; } 
					#MEIQIA-BTN-CHAT { display: block; position: relative; width: 60px; height: 60px; margin-top: 20px; border: 1px solid rgba(0, 0, 0, .1); border-radius: 31px; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); cursor: pointer; text-decoration: none; background-color: ", r += n(o), r += "; } 
					#MEIQIA-BTN-CALL #MEIQIA-BTN-ICON, #MEIQIA-BTN-CHAT #MEIQIA-BTN-ICON { position: absolute; top: 15px; left: 15px; width: 32px; height: 32px; }
					#MEIQIA-BTN-CHAT #MEIQIA-CIRCLE { position: absolute; display: none; width: 26px; height: 26px; text-align: center; line-height: 26px; font-size: 14px; color: #fff; border-radius: 15px; background-color: #ff3b30; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE { position: absolute; top: 50%; display: none; width: 260px; margin-top: -48px; border: 1px solid #f7f7f7; border-radius: 4px; color: #000;
							text-align: left; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; }
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-ARROW1 { position: absolute; z-index: 2; font-size: 0; line-height: 0; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-ARROW2 { position: absolute; z-index: 1; font-size: 0; line-height: 0; } ",
					r += "left" === i.type ? "
					#MEIQIA-BTN-CHAT #MEIQIA-CIRCLE { top: -10px; right: -10px; } #MEIQIA-BTN-CHAT #MEIQIA-BUBBLE { left: 74px; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-ARROW1 { left: -8px; top: 42px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-right: 8px solid #fff; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-ARROW2 { left: -10px; top: 43px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-right: 9px solid #f7f7f7; } " : " 
					#MEIQIA-BTN-CHAT #MEIQIA-CIRCLE { top: -10px; left: -10px; } #MEIQIA-BTN-CHAT #MEIQIA-BUBBLE { right: 74px; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-ARROW1 { right: -8px; top: 42px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-left: 8px solid #fff; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-ARROW2 { right: -10px; top: 43px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-left: 9px solid #f7f7f7; } ", r += " 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-CLOSE { position: absolute; display: none; top: 12px; right: 12px; width: 10px; height: 10px; background-position: -5px -245px; cursor: pointer; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE:hover #MEIQIA-BUBBLE-CLOSE { display: block; } #MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-INSIDE { margin: 12px 18px; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; } #MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-MSG { height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(r)
			...
			var e = this,
				...
				i = t.position,
				o = "";
			return o += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: ", o += n(i.bottom), o += "px; ", "left" === i.type ? (o += " left: ", o += n(i.horizontal), o += "px; ") : (o += " right: ", o += n(i.horizontal), o += "px; "),
					o += " z-index: 2147483647; width: auto; height: auto; padding: 0; margin: 0; border: 0; font-family: 'Helvetica Neue', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif; background-color: transparent; } 
					#MEIQIA-BTN, #MEIQIA-BTN span, #MEIQIA-BTN div, #MEIQIA-BTN img { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } 
					#MEIQIA-BTN { cursor: pointer; text-decoration: none; } 
					#MEIQIA-BTN #MEIQIA-BTN-PICTURE { display: block; border: 0; } 
					#MEIQIA-BTN #MEIQIA-CIRCLE { position: absolute; display: none; opacity: 0; filter: alpha(opacity=0); } 
					#MEIQIA-BTN #MEIQIA-BUBBLE { position: absolute; bottom: 0; display: none; width: 260px; border: 1px solid #f7f7f7; border-radius: 4px; color: #000; text-align: left; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { position: absolute; z-index: 2; font-size: 0; line-height: 0; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { position: absolute; z-index: 1; font-size: 0; line-height: 0; } ", 
					o += "left" === i.type ? " #MEIQIA-BTN #MEIQIA-BUBBLE { right: 0; margin-right: -274px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { left: -8px; top: 42px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-right: 8px solid #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { left: -10px; top: 43px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-right: 9px solid #f7f7f7; } " : " #MEIQIA-BTN #MEIQIA-BUBBLE { left: 0; margin-left: -274px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { right: -8px; top: 42px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-left: 8px solid #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { right: -10px; top: 43px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-left: 9px solid #f7f7f7; } ", 
					o += " #MEIQIA-BTN #MEIQIA-BUBBLE-CLOSE { position: absolute; display: none; top: 12px; right: 12px; width: 10px; height: 10px; background-position: -5px -245px; cursor: pointer; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE:hover #MEIQIA-BUBBLE-CLOSE { display: block; } #MEIQIA-BTN #MEIQIA-BUBBLE-INSIDE { margin: 12px 18px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); }
					#MEIQIA-BTN #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; }
					#MEIQIA-BTN #MEIQIA-BUBBLE-MSG { height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; }
					#MEIQIA-BTN #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(o)
			...
			return r += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: ", 
					r += n(i.bottom), r += "px; ", "left" === i.type ? (r += " left: ", r += n(i.horizontal), r += "px; ") : (r += " right: ", r += n(i.horizontal), r += "px; "), 
					r += " z-index: 2147483647; width: auto; height: auto; padding: 0; margin: 0; border: 0; font-family: 'Helvetica Neue', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif; background-color: transparent; } 
					#MEIQIA-BTN, #MEIQIA-BTN span, #MEIQIA-BTN div, #MEIQIA-BTN img { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } 
					#MEIQIA-BTN { display: block; width: 60px; height: 60px; border: 1px solid rgba(0, 0, 0, .1); border-radius: 31px; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); cursor: pointer; text-decoration: none; background-color: ", r += n(o), r += "; } 
					#MEIQIA-BTN #MEIQIA-BTN-ICON { position: absolute; top: 15px; left: 15px; width: 32px; height: 32px; } 
					#MEIQIA-BTN #MEIQIA-CIRCLE { position: absolute; display: none; width: 26px; height: 26px; text-align: center; line-height: 26px; font-size: 14px; color: #fff; border-radius: 15px; background-color: #ff3b30; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE { position: absolute; top: 50%; display: none; width: 260px; margin-top: -48px; border: 1px solid #f7f7f7; border-radius: 4px; color: #000; text-align: left;
							box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; }
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { position: absolute; z-index: 2; font-size: 0; line-height: 0; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { position: absolute; z-index: 1; font-size: 0; line-height: 0; } ", 
					r += "left" === i.type ? " #MEIQIA-BTN #MEIQIA-CIRCLE { top: -10px; right: -10px; } #MEIQIA-BTN #MEIQIA-BUBBLE { left: 74px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { left: -8px; top: 42px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-right: 8px solid #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { left: -10px; top: 43px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-right: 9px solid #f7f7f7; } " : " 
					#MEIQIA-BTN #MEIQIA-CIRCLE { top: -10px; left: -10px; } #MEIQIA-BTN #MEIQIA-BUBBLE { right: 74px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { right: -8px; top: 42px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-left: 8px solid #fff; }
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { right: -10px; top: 43px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-left: 9px solid #f7f7f7; } ", 
					r += " #MEIQIA-BTN #MEIQIA-BUBBLE-CLOSE { position: absolute; display: none; top: 12px; right: 12px; width: 10px; height: 10px; background-position: -5px -245px; cursor: pointer; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE:hover #MEIQIA-BUBBLE-CLOSE { display: block; } #MEIQIA-BTN #MEIQIA-BUBBLE-INSIDE { margin: 12px 18px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-MSG { height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; } #MEIQIA-BTN #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(r)
			...
			var e = this,
				...
				r = t.textColor,
				a = "";
			return a += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: ", 
					a += n(i.bottom), a += "px; ", a += "left" === i.type ? " left: 0; " : " right: 0; ", a += " z-index: 2147483647; width: auto; height: auto; padding: 0; margin: 0; border: 0; font-family: 'Helvetica Neue', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif; background-color: transparent; } 
					#MEIQIA-BTN, #MEIQIA-BTN span, #MEIQIA-BTN div, #MEIQIA-BTN img { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } 
					#MEIQIA-BTN { display: block; width: 40px; height: auto; max-height: 90vh; font-size: 16px; text-decoration: none; border-top: 1px solid rgba(0, 0, 0, .1); border-bottom: 1px solid rgba(0, 0, 0, .1);
						box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); background-color: ", a += n(o), a += "; color: ", a += n(r), a += "; } 
					#MEIQIA-BTN #MEIQIA-BTN-ICON { display: block; width: 20px; height: 20px; margin: 10px; } #MEIQIA-BTN #MEIQIA-BTN-LINE { display: inline-block; width: 100%; height: 1px; 
						background-color: rgba(0, 0, 0, .08); vertical-align: middle; } 
					#MEIQIA-BTN #MEIQIA-BTN-TEXT { display: block; max-height: 80%; padding: 0 10px; margin-top: 10px; text-align: center; overflow: hidden; font-size: 16px; 
						color: ", a += n(r), a += "; line-height: 1.428571429; word-break: break-all; word-wrap: break-word; letter-spacing: 5px; *letter-spacing: 5px; -webkit-writing-mode: vertical-rl; writing-mode: vertical-rl; white-space: nowrap; text-overflow: ellipsis; } 
					#MEIQIA-BTN #MEIQIA-CIRCLE { position: absolute; display: none; width: 26px; height: 26px; text-align: center; line-height: 26px; font-size: 14px; color: #fff; border-radius: 15px; background-color: #ff3b30; }
					#MEIQIA-BTN #MEIQIA-BUBBLE { position: absolute; bottom: 40%; display: none; width: 260px; border: 1px solid #f7f7f7; color: #000; text-align: left; box-shadow: 0 5px 16px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { position: absolute; z-index: 2; font-size: 0; line-height: 0; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { position: absolute; z-index: 1; font-size: 0; line-height: 0; } ",
					a += "left" === i.type ? " #MEIQIA-BTN { border-right: 1px solid rgba(0, 0, 0, .1); } #MEIQIA-BTN #MEIQIA-CIRCLE { top: -13px; right: -13px; } #MEIQIA-BTN #MEIQIA-BUBBLE { left: 60px; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { left: -8px; top: 20px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-right: 8px solid #fff; }
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { left: -10px; top: 19px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-right: 9px solid #f7f7f7; } " : " 
					#MEIQIA-BTN { border-left: 1px solid rgba(0, 0, 0, .1); } #MEIQIA-BTN #MEIQIA-CIRCLE { top: -13px; left: -13px; } #MEIQIA-BTN #MEIQIA-BUBBLE { right: 60px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { right: -8px; top: 20px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-left: 8px solid #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { right: -10px; top: 19px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-left: 9px solid #f7f7f7; } ", 
					a += " #MEIQIA-BTN #MEIQIA-BUBBLE-CLOSE { position: absolute; top: 6px; right: 6px; width: 26px; height: 26px; background-position: 3px -238px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-INSIDE { margin: 10px; } #MEIQIA-BTN #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; } #MEIQIA-BTN #MEIQIA-BUBBLE-MSG { *height: 40px; max-height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(a)
			...
			return r += ".BODY-FOR-MEIQIA { margin-bottom: 50px !important; } #MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: 0; left: 0; right: 0; z-index: 2147483647; width: 100%; height: auto; padding: 0; margin: 0; border: 0; font-family: 'Helvetica Neue', Helvetica, Arial, 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif; background-color: transparent; } #MEIQIA-BTN, #MEIQIA-BTN span, #MEIQIA-BTN div, #MEIQIA-BTN img { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-BTN { display: block; width: 100%; height: 50px; text-align: center; line-height: 50px; text-decoration: none; border-top: 1px solid rgba(0, 0, 0, .1); box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); background-color: ", 
					r += n(i), r += "; color: ", r += n(o), r += "; font-size: 16px; } #MEIQIA-BTN #MEIQIA-BTN-ICON { display: inline-block; width: 20px; height: 20px; margin: 15px 5px 0; vertical-align: top; } #MEIQIA-BTN #MEIQIA-BTN-LINE { display: none; } #MEIQIA-BTN #MEIQIA-BTN-TEXT { font-size: 16px; color: ",
					r += n(o), r += "; } #MEIQIA-BTN #MEIQIA-CIRCLE { position: absolute; top: -13px; right: 13px; display: none; width: 26px; height: 26px; text-align: center; line-height: 26px; font-size: 14px; color: #fff; border-radius: 15px; background-color: #ff3b30; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE { position: absolute; right: 2%; bottom: 75px; left: 2%; display: none; width: 96%; border: 1px solid #f7f7f7; color: #000; text-align: left; box-shadow: 0 5px 16px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { position: absolute; z-index: 2; font-size: 0; line-height: 0; border-width: 8px 7px 0px; border-color: #fff transparent; border-style: solid dashed dashed; }
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { position: absolute; z-index: 1; font-size: 0; line-height: 0; border-width: 10px 8px 0px; border-color: #f7f7f7 transparent; border-style: solid dashed dashed; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { right: 12px; bottom: -8px; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { right: 11px; bottom: -10px; } #MEIQIA-BTN #MEIQIA-BUBBLE-CLOSE { position: absolute; top: 6px; right: 6px; width: 26px; height: 26px; background-position: 3px -238px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-INSIDE { margin: 10px; } #MEIQIA-BTN #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; } #MEIQIA-BTN #MEIQIA-BUBBLE-MSG { *height: 40px; max-height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(r)
			...
			var e = this,
				...
				a = "";
			return a += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: ", 
					a += n(i.bottom), a += "px; ", "left" === i.type ? (a += " left: ", a += n(i.horizontal), a += "px; ") : (a += " right: ", a += n(i.horizontal), a += "px; "), 
					...
					a += n(o), a += "; } #MEIQIA-BTN-CHAT { display: block; position: relative; width: 60px; height: 60px; margin-top: 20px; border: 1px solid rgba(0, 0, 0, .1); border-radius: 31px; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); cursor: pointer; text-decoration: none; background-color: ", 
					a += n(o), a += "; } #MEIQIA-BTN-CALL #MEIQIA-BTN-ICON, #MEIQIA-BTN-CHAT #MEIQIA-BTN-ICON { display: block; width: 32px; height: 32px; margin: 14px; } #MEIQIA-BTN-CHAT #MEIQIA-CIRCLE { position: absolute; top: 0; left: 0; display: none; width: 60px; height: 60px; border-radius: 30px; text-align: center; font-size: 18px; line-height: 60px; background-color: ", 
					a += n(o), a += "; color: ", a += n(r), a += "; } #MEIQIA-BTN-CHAT #MEIQIA-BUBBLE { position: fixed; right: 0; bottom: ", 
					a += n(i.bottom), a += "px; left: 0; display: none; width: 90%; margin: 0 5% 74px 5%; border: 1px solid #f7f7f7; color: #000; text-align: left; box-shadow: 0 5px 16px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-ARROW1 { display: none; } #MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-ARROW2 { display: none; }
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-CLOSE { position: absolute; top: 6px; right: 6px; width: 26px; height: 26px; background-position: -3px -387px; } 
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-INSIDE { margin: 10px; } #MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: 
															top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); }
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; } #MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-MSG { height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; }
					#MEIQIA-BTN-CHAT #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(a)
			...
			var e = this,
				...
				i = t.position,
				o = "";
			return o += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: ", o += n(i.bottom), o += "px; ", "left" === i.type ? (o += " left: ", o += n(i.horizontal), o += "px; ") : (o += " right: ", 
					o += n(i.horizontal), o += "px; "), 
					...
					"left" === i.type ? (o += " #MEIQIA-BTN #MEIQIA-BUBBLE { left: 0; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { left: ", o += n(i.horizontal), o += "px; bottom: -8px; border-top: 8px solid #fff; border-right: 7px solid transparent; border-left: 7px solid transparent; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { left: ", 
					o += n(i.horizontal), o += "px; bottom: -9px; margin-left: -1px; border-top: 9px solid #f7f7f7; border-right: 8px solid transparent; border-left: 8px solid transparent; } ") : (o += " #MEIQIA-BTN #MEIQIA-BUBBLE { right: 0; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { right: ", 
					o += n(i.horizontal), o += "px; bottom: -8px; border-top: 8px solid #fff; border-right: 7px solid transparent; border-left: 7px solid transparent; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { right: ",
					o += n(i.horizontal), o += "px; bottom: -9px; margin-right: -1px; border-top: 9px solid #f7f7f7; border-right: 8px solid transparent; border-left: 8px solid transparent; } "), 
					o += " #MEIQIA-BTN #MEIQIA-BUBBLE-CLOSE { position: absolute; top: 6px; right: 6px; width: 26px; height: 26px; background-position: 3px -238px; } 
							#MEIQIA-BTN #MEIQIA-BUBBLE-INSIDE { margin: 10px; } #MEIQIA-BTN #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; 
								margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); }
							#MEIQIA-BTN #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; } 
							#MEIQIA-BTN #MEIQIA-BUBBLE-MSG { height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; } 
							#MEIQIA-BTN #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(o)
			...
			return a += "#MEIQIA-BTN-HOLDER { display: none; position: fixed; bottom: ", 
					...
					a += n(o), a += "; } #MEIQIA-BTN #MEIQIA-BTN-ICON { display: block; width: 32px; height: 32px; margin: 14px; } #MEIQIA-BTN #MEIQIA-CIRCLE { position: absolute; top: 0; left: 0; display: none; width: 60px; height: 60px; border-radius: 30px; text-align: center; font-size: 18px; line-height: 60px; background-color: ", 
					a += n(o), a += "; color: ", a += n(r), a += "; } #MEIQIA-BTN #MEIQIA-BUBBLE { position: fixed; right: 0; bottom: ", 
					a += n(i.bottom), a += "px; left: 0; display: none; width: 90%; margin: 0 5% 74px 5%; border: 1px solid #f7f7f7; color: #000; text-align: left; box-shadow: 0 5px 16px 0 rgba(0, 0, 0, .16); line-height: 1.428571429; background-color: #fff; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-ARROW1 { display: none; } #MEIQIA-BTN #MEIQIA-BUBBLE-ARROW2 { display: none; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-CLOSE { position: absolute; top: 6px; right: 6px; width: 26px; height: 26px; background-position: -3px -387px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-INSIDE { margin: 10px; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-AVATAR { width: 26px; height: 26px; border-radius: 13px; margin-right: 6px; vertical-align: top; box-shadow: 0 0 8px 0 rgba(0, 0, 0, .15); } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-NAME { display: inline-block; margin-top: 3px; font-size: 16px; color: #000; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-MSG { height: 40px; margin-top: 5px; font-size: 14px; overflow: hidden; color: #000; } 
					#MEIQIA-BTN #MEIQIA-BUBBLE-MSG img { width: 16px; height: 16px; } ", new I(a)
			...
			var e = this,
				...
				o = t.tail,
				r = "";
			return r += '.MEIQIA-ICON { background-size: 40px auto !important; background-repeat: no-repeat !important; background-image: url("', r += n(i), r += "/images/icon-mq.png?v=", r += n(o), r += '") !important; } @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2) { .MEIQIA-ICON { background-image: url("', 
					r += n(i), r += "/images/icon-mq@2x.png?v=", r += n(o), r += '") !important; } } 
					.MEIQIA-ICON-CHAT1 { background-position: 0 0 !important; } 
					.MEIQIA-ICON-CHAT2 { background-position: 0 -20px !important; } 
					.MEIQIA-ICON-CHAT3 { background-position: 0 -40px !important; } 
					.MEIQIA-ICON-CHAT4 { background-position: 0 -60px !important; } 
					.MEIQIA-ICON-CHAT5 { background-position: 0 -80px !important; } 
					.MEIQIA-ICON-CHAT6 { background-position: 0 -100px !important; }
					.MEIQIA-ICON-CHAT7 { background-position: 0 -120px !important; }
					.MEIQIA-ICON-CHAT8 { background-position: 0 -140px !important; } 
					.MEIQIA-ICON-CHAT9 { background-position: 0 -160px !important; } 
					.MEIQIA-ICON-CHAT10 { background-position: 0 -180px !important; } 
					.MEIQIA-ICON-CHAT11 { background-position: 0 -200px !important; } 
					.MEIQIA-ICON-CHAT12 { background-position: 0 -220px !important; } 
					.MEIQIA-ICON-TICKET1 { background-position: -20px 0 !important; } 
					.MEIQIA-ICON-TICKET2 { background-position: -20px -20px !important; } 
					.MEIQIA-ICON-TICKET3 { background-position: -20px -40px !important; } 
					.MEIQIA-ICON-TICKET4 { background-position: -20px -60px !important; } 
					.MEIQIA-ICON-TICKET5 { background-position: -20px -80px !important; } 
					.MEIQIA-ICON-TICKET6 { background-position: -20px -100px !important; } 
					.MEIQIA-ICON-TICKET7 { background-position: -20px -120px !important; } 
					.MEIQIA-ICON-TICKET8 { background-position: -20px -140px !important; } 
					.MEIQIA-ICON-TICKET9 { background-position: -20px -160px !important; } 
					.MEIQIA-ICON-TICKET10 { background-position: -20px -180px !important; } 
					.MEIQIA-ICON-TICKET11 { background-position: -20px -200px !important; } 
					.MEIQIA-ICON-TICKET12 { background-position: -20px -220px !important; } ', new I(r)
			...
			return r += '.MEIQIA-ICON { background-size: 64px auto !important; background-repeat: no-repeat !important; background-image: url("', 
					r += n(i), r += "/images/icon-mq-round.png?v=", r += n(o), r += '") !important; }
					@media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), 
					only screen and (min-device-pixel-ratio: 2) { .MEIQIA-ICON { background-image: url("', r += n(i), r += "/images/icon-mq-round@2x.png?v=", r += n(o), r += '") !important; } } 
					.MEIQIA-ICON-CHAT1 { background-position: 0 0 !important; } .MEIQIA-ICON-CHAT2 { background-position: 0 -32px !important; } 
					.MEIQIA-ICON-CHAT3 { background-position: 0 -64px !important; } .MEIQIA-ICON-CHAT4 { background-position: 0 -96px !important; }
					.MEIQIA-ICON-CHAT5 { background-position: 0 -128px !important; } .MEIQIA-ICON-CHAT6 { background-position: 0 -160px !important; } 
					.MEIQIA-ICON-CHAT7 { background-position: 0 -224px !important; } .MEIQIA-ICON-CHAT8 { background-position: 0 -256px !important; } 
					.MEIQIA-ICON-CHAT9 { background-position: 0 -288px !important; } .MEIQIA-ICON-CHAT10 { background-position: 0 -320px !important; } 
					.MEIQIA-ICON-CHAT11 { background-position: 0 -352px !important; } .MEIQIA-ICON-CHAT12 { background-position: 0 -384px !important; } 
					.MEIQIA-ICON-TICKET1 { background-position: -32px 0 !important; } .MEIQIA-ICON-TICKET2 { background-position: -32px -32px !important; } 
					.MEIQIA-ICON-TICKET3 { background-position: -32px -64px !important; } .MEIQIA-ICON-TICKET4 { background-position: -32px -96px !important; }
					.MEIQIA-ICON-TICKET5 { background-position: -32px -128px !important; } .MEIQIA-ICON-TICKET6 { background-position: -32px -160px !important; }
					.MEIQIA-ICON-TICKET7 { background-position: -32px -224px !important; } .MEIQIA-ICON-TICKET8 { background-position: -32px -256px !important; } 
					.MEIQIA-ICON-TICKET9 { background-position: -32px -288px !important; } .MEIQIA-ICON-TICKET10 { background-position: -32px -320px !important; } 
					.MEIQIA-ICON-TICKET11 { background-position: -32px -352px !important; } .MEIQIA-ICON-TICKET12 { background-position: -32px -384px !important; }
					.MEIQIA-ICON-CALL { background-position: -32px -448px !important; }', new I(r)
			...
			var e = this,
				...
				r = "";
			return r += "
					#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } 
					#MEIQIA-INVITE { position: fixed; z-index: 2147483647; display: none; width: 340px; height: 130px; margin-bottom: 64px; border: 1px solid #f7f7f7; 
						border-radius: 4px; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); text-align: left; cursor: pointer; color: #000; line-height: 1.428571429; background-color: #fff; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW1, #MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { position: absolute; font-size: 0; line-height: 0; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1 { z-index: 2; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { z-index: 1; } ", "left" === n.type ? (r += " ", "bottom" === i ? (r += " #MEIQIA-INVITE { bottom: 0; left: ", r += o(n.horizontal), r += "px; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW1 { left: 12px; bottom: -8px; border-top: 8px solid #fff; border-right: 7px solid transparent; border-left: 7px solid transparent; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { left: 11px; bottom: -10px; border-top: 9px solid #f7f7f7; border-right: 8px solid transparent; border-left: 8px solid transparent; } ") : "aside" === i && (r += " 
						#MEIQIA-INVITE { left: 60px; bottom: ", r += o(n.bottom), r += "px; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW1 { left: -8px; top: 60px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-right: 8px solid #fff; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { left: -9px; top: 59px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-right: 9px solid #f7f7f7; } "), r += " ") : 
						(r += " ", "bottom" === i ? (r += " #MEIQIA-INVITE { right: ", r += o(n.horizontal), r += "px; bottom: 0; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW1 { right: 12px; bottom: -8px; border-top: 8px solid #fff; border-right: 7px solid transparent; border-left: 7px solid transparent; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { right: 11px; bottom: -10px; border-top: 9px solid #f7f7f7; border-right: 8px solid transparent; border-left: 8px solid transparent; } ") :
						"aside" === i && (r += " #MEIQIA-INVITE { right: 60px; bottom: ", r += o(n.bottom), r += "px; } 
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW1 { right: -8px; top: 60px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-left: 8px solid #fff; }
						#MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { right: -9px; top: 59px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-left: 9px solid #f7f7f7; } "), r += " "), 
						r += " ", ("round" === i || "call" === i) && (r += " #MEIQIA-INVITE { top: 50%; left: 50%; margin: -65px 0 0 -170px; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1, #MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { display: none; } "), 
						r += " ", "picture" === i && (r += " #MEIQIA-INVITE { top: 50%; left: 50%; margin: -65px 0 0 -170px; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1, #MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { display: none; } "), 
						r += " #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; right: -20px; top: -20px; width: 40px; height: 40px; cursor: pointer; ", r += "round" === i || "call" === i ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", r += " } 
						#MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:hover { ", r += "round" === i || "call" === i ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", r += " } 
						#MEIQIA-INVITE #MEIQIA-INVITE-INSIDE { width: 300px; height: 44px; margin: 46px 20px 0; text-align: left; font-size: 14px; 
							line-height: 22px; overflow: hidden; color: #000; /*word-break: break-all;*/ } ", new I(r)
			...
			var e = this,
				...
				a = t.btnType,
				s = "";
			return s += '#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { background-size: 280px auto; background-repeat: no-repeat; background-image: url("', 
					s += n(i), s += "/images/invite-bgi-2.png?v=", s += n(o), s += '"); } @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2) { #MEIQIA-INVITE { background-image: url("', 
					s += n(i), s += "/images/invite-bgi-2@2x.png?v=", s += n(o), s += '"); } } #MEIQIA-INVITE { position: fixed; ', s += 1 === r.type ? " margin: -128px 0 0 -140px; " : " margin: 0; ", 
					s += " ", 2 === r.type ? (s += " bottom: ", s += n(r.bottom), s += "px; left: ", s += n(r.side), s += "px; ") : 3 === r.type ? (s += " bottom: ", s += n(r.bottom), s += "px; right: ", 
					s += n(r.side), s += "px; ") : s += " top: 50%; left: 50%; ", s += " z-index: 2147483647; display: none; width: 280px; height: 256px; text-align: left; cursor: pointer; line-height: 1.428571429; } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; right: 9px; top: -5px; width: 40px; height: 40px; cursor: pointer; ", 
					s += "round" === a || "call" === a ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", 
					s += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:hover { ", s += "round" === a || "call" === a ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", 
					s += " } #MEIQIA-INVITE #MEIQIA-INVITE-INSIDE { width: 156px; height: 68px; margin: 65px 62px 0; text-align: left; font-size: 13px; line-height: 22px; color: #766e6c; overflow: hidden; /*word-break: break-all;*/ } ", 
					new I(s)
			...
			var e = this,
				...
				a = t.btnType,
				s = "";
			return s += '#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { background-size: 318px auto; background-repeat: no-repeat; background-image: url("', 
					s += n(i), s += "/images/invite-bgi-3.png?v=", s += n(o), s += '"); } @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2) { #MEIQIA-INVITE { background-image: url("', 
					s += n(i), s += "/images/invite-bgi-3@2x.png?v=", s += n(o), s += '"); } } #MEIQIA-INVITE { position: fixed; ', 
					s += 1 === r.type ? " margin: -78px 0 0 -159px; " : " margin: 0; ", s += " ", 2 === r.type ? (s += " bottom: ", 
					s += n(r.bottom), s += "px; left: ", s += n(r.side), s += "px; ") : 3 === r.type ? (s += " bottom: ", s += n(r.bottom), s += "px; right: ", s += n(r.side), s += "px; ") : s += " top: 50%; left: 50%; ",
					s += " z-index: 2147483647; display: none; width: 318px; height: 156px; text-align: left; cursor: pointer; line-height: 1.428571429; } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; top: -3px; right: -3px; width: 40px; height: 40px; cursor: pointer; ", 
					s += "round" === a || "call" === a ? " background-position: -12px -492px; " : " background-position: 0 -260px; ",
					s += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:hover { ", s += "round" === a || "call" === a ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-INSIDE { width: 170px; height: 44px; margin: 56px 0 0 110px; text-align: left; font-size: 13px; line-height: 22px; color: #4c4c4c; overflow: hidden; /*word-break: break-all;*/ } ",
					new I(s)
			...
			var e = this,
				...
				s = "";
			return s += '#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { background-size: 318px auto; background-repeat: no-repeat; background-image: url("', 
			s += n(i), s += "/images/invite-bgi-4.png?v=", s += n(o), s += '"); } @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2) { #MEIQIA-INVITE { background-image: url("', 
			s += n(i), s += "/images/invite-bgi-4@2x.png?v=", s += n(o), s += '"); } } #MEIQIA-INVITE { position: fixed; ', s += 1 === r.type ? " margin: -78px 0 0 -159px; " : " margin: 0; ", 
			s += " ", 2 === r.type ? (s += " bottom: ", s += n(r.bottom), s += "px; left: ", s += n(r.side), s += "px; ") : 3 === r.type ? (s += " bottom: ", s += n(r.bottom), s += "px; right: ", 
			s += n(r.side), s += "px; ") : s += " top: 50%; left: 50%; ", s += " z-index: 2147483647; display: none; width: 318px; height: 156px; text-align: left; cursor: pointer; line-height: 1.428571429; } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; right: -3px; top: -3px; width: 40px; height: 40px; cursor: pointer; ", 
			s += "round" === a || "call" === a ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:hover { ", 
			s += "round" === a || "call" === a ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-INSIDE { width: 170px; height: 44px; margin: 56px 0 0 46px; text-align: left; font-size: 13px; line-height: 22px; color: #1e4977; overflow: hidden; /*word-break: break-all;*/ } ", 
			new I(s)
			...
			var e = this,
				...
				s = t.btnType,
				l = "";
			return l += "#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span, #MEIQIA-INVITE img { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { position: fixed; ", 
					1 === n.type ? (l += " margin: -", l += i(o / 2), l += "px 0 0 -", l += i(r / 2), l += "px; ") : l += " margin: 0; ", l += " ", 2 === n.type ? (l += " bottom: ", l += i(n.bottom), l += "px; left: ", 
					l += i(n.side), l += "px; ") : 3 === n.type ? (l += " bottom: ", l += i(n.bottom), l += "px; right: ", l += i(n.side), l += "px; ") : l += " top: 50%; left: 50%; ", l += " display: none; z-index: 2147483647; width: ", 
					l += i(r), l += "px; height: ", l += i(o), l += "px; cursor: pointer; ", 1 === a && (l += " border-radius: 8px; box-shadow: 0 3px 18px 0 rgba(238, 238, 238, .5); "), l += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; right: -20px; top: -20px; width: 40px; height: 40px; cursor: pointer; ", 
					l += "round" === s || "call" === s ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", l += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:hover { ", 
					l += "round" === s || "call" === s ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", l += " } ",
					new I(l)
			...
			var e = this,
				...
				a = t.actions,
				s = (t.v, t.k, "");
			return s += "#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE img, #MEIQIA-INVITE a { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { display: none; position: fixed; ",
					1 === n.type ? (s += " margin: -", s += i(o.height / 2), s += "px 0 0 -", s += i(o.width / 2), s += "px;; ") : s += " margin: 0; ", s += " ",
					2 === n.type ? (s += " bottom: ", s += i(n.bottom), s += "px; left: ", s += i(n.side), s += "px; ") : 3 === n.type ? (s += " bottom: ", s += i(n.bottom), s += "px; right: ", 
					s += i(n.side), s += "px; ") : s += " top: 50%; left: 50%; ", s += " z-index: 2147483647; width: ", s += i(o.width), s += "px; height: ", s += i(o.height), s += "px; } #MEIQIA-INVITE #MEIQIA-INVITE-BG { position: absolute; top: 0; left: 0; z-index: 1; width: 100%; height: 100%; } #MEIQIA-INVITE #MEIQIA-INVITE-ACTIONS { position: relative; top: 0; left: 0; z-index: 2; width: 100%; height: 100%; } ",
					r(a, function(t, e) {
						s += " #MEIQIA-INVITE #MEIQIA-INVITE-ACTION-", s += i(e), s += " { display: block; position: absolute; top: ", s += i(t.position.top), s += "px; left: ", s += i(t.position.left), s += "px; width: ", 
						s += i(t.width), s += "px; height: ", s += i(t.height), s += "px; cursor: pointer; background-image: url(about:blank); // 解决 IE10 以下空的 absolute a 标签无法响应 click 的问题 } "
			}), s += " ", new I(s)
			...
			return r += "#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { position: fixed; z-index: 2147483647; display: none; width: 260px; height: 130px; border: 1px solid #f7f7f7; border-radius: 4px; box-shadow: 0 0 14px 0 rgba(0, 0, 0, .16); text-align: left; cursor: pointer; color: #000; line-height: 1.428571429; background-color: #fff; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1, #MEIQIA-INVITE-ARROW2 { position: absolute; font-size: 0; line-height: 0; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1 { z-index: 2; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { z-index: 1; } ",
						...
						r += " ", "left" === i.type ? (r += " ", "aside" === n && (r += " #MEIQIA-INVITE { left: 60px; bottom: ", r += o(i.bottom), r += "px; margin-bottom: 30px; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1 { left: -8px; top: 60px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-right: 8px solid #fff; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { left: -9px; top: 59px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-right: 9px solid #f7f7f7; } "), 
						r += " ") : (r += " ", "aside" === n && (r += " #MEIQIA-INVITE { right: 60px; bottom: ", r += o(i.bottom), r += "px; margin-bottom: 30px; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1 { right: -8px; top: 60px; border-top: 7px solid transparent; border-bottom: 7px solid transparent; border-left: 8px solid #fff; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { right: -9px; top: 59px; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-left: 9px solid #f7f7f7; } "), 
						r += " "), r += " ", ("round" === n || "call" === n) && (r += " #MEIQIA-INVITE { top: 50%; left: 50%; margin: -65px 0 0 -130px; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1, #MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { display: none; } "),
						r += " ", "picture" === n && (r += " #MEIQIA-INVITE { top: 50%; left: 50%; margin: -65px 0 0 -130px; } #MEIQIA-INVITE #MEIQIA-INVITE-ARROW1, #MEIQIA-INVITE #MEIQIA-INVITE-ARROW2 { display: none; } "), 
						r += " #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; right: -20px; top: -20px; width: 40px; height: 40px; ",
						r += "round" === n || "call" === n ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", r += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:active { ",
						r += "round" === n || "call" === n ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", r += " } #MEIQIA-INVITE #MEIQIA-INVITE-INSIDE { width: 88%; height: 44px; margin: 46px 6% 0; text-align: left; font-size: 14px; line-height: 22px; overflow: hidden; color: #000; /*word-break: break-all;*/ } ",
						new I(r)
			...
			return s += '#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { background-size: 280px auto; background-repeat: no-repeat; background-image: url("',
					s += n(i), s += "/images/invite-bgi-2.png?v=", s += n(o), s += '"); } @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2) { #MEIQIA-INVITE { background-image: url("',
					s += n(i), s += "/images/invite-bgi-2@2x.png?v=", s += n(o), s += '"); } } #MEIQIA-INVITE { position: fixed; ', s += 1 === r.type ? " margin: -128px 0 0 -140px; " : " margin-left: -140px; ",
					s += " ", 2 === r.type ? (s += " top: ", s += n(r.value), s += "px; ") : 3 === r.type ? (s += " bottom: ", s += n(r.value), s += "px; ") : s += " top: 50%; ", s += " left: 50%; z-index: 2147483647; display: none; width: 280px; height: 256px; text-align: left; line-height: 1.428571429; } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; right: 9px; top: -5px; width: 40px; height: 40px; ", 
					s += "round" === a || "call" === a ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:active { ",
					s += "round" === a || "call" === a ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-INSIDE { width: 156px; height: 68px; margin: 65px 62px 0; text-align: left; font-size: 13px; line-height: 22px; color: #766e6c; overflow: hidden; /*word-break: break-all;*/ } ",
					new I(s)
			...
			return s += '#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { background-size: 318px auto; background-repeat: no-repeat; background-image: url("',
			s += n(i), s += "/images/invite-bgi-3.png?v=", s += n(o), s += '"); } @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2) { #MEIQIA-INVITE { background-image: url("',
			s += n(i), s += "/images/invite-bgi-3@2x.png?v=", s += n(o), s += '"); } } #MEIQIA-INVITE { position: fixed; ', s += 1 === r.type ? " margin: -78px 0 0 -159px; " : " margin-left: -159px; ", 
			s += " ", 2 === r.type ? (s += " top: ", s += n(r.value), s += "px; ") : 3 === r.type ? (s += " bottom: ", s += n(r.value), s += "px; ") : s += " top: 50%; ", s += " left: 50%; z-index: 2147483647; display: none; width: 318px; height: 156px; text-align: left; line-height: 1.428571429; } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; top: -3px; right: -3px; width: 40px; height: 40px; ",
			s += "round" === a || "call" === a ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:active { ",
			s += "round" === a || "call" === a ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-INSIDE { width: 170px; height: 44px; margin: 56px 0 0 110px; text-align: left; font-size: 13px; line-height: 22px; color: #4c4c4c; overflow: hidden; /*word-break: break-all;*/ } ",
			new I(s)
			...
			return s += '#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { background-size: 318px auto; background-repeat: no-repeat; background-image: url("', 
			s += n(i), s += "/images/invite-bgi-4.png?v=", s += n(o), s += '"); } @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2) { #MEIQIA-INVITE { background-image: url("',
			s += n(i), s += "/images/invite-bgi-4@2x.png?v=", s += n(o), s += '"); } } #MEIQIA-INVITE { position: fixed; ', s += 1 === r.type ? " margin: -78px 0 0 -159px; " : " margin-left: -159px; ", 
			s += " ", 2 === r.type ? (s += " top: ", s += n(r.value), s += "px; ") : 3 === r.type ? (s += " bottom: ", s += n(r.value), s += "px; ") : s += " top: 50%; ", s += " left: 50%; z-index: 2147483647; display: none; width: 318px; height: 156px; text-align: left; line-height: 1.428571429; } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; right: -3px; top: -3px; width: 40px; height: 40px; ",
			s += "round" === a || "call" === a ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:active { ", 
			s += "round" === a || "call" === a ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", s += " } #MEIQIA-INVITE #MEIQIA-INVITE-INSIDE { width: 170px; height: 44px; margin: 56px 0 0 46px; text-align: left; font-size: 13px; line-height: 22px; color: #1e4977; overflow: hidden; /*word-break: break-all;*/ } ",
			new I(s)
			...
			var e = this,
				...
				s = t.btnType,
				l = "";
			return l += "#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE span, #MEIQIA-INVITE img { float: none; width: ", l += n(i), l += "px; height: ", l += n(o), l += "px; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { position: fixed; ",
			1 === r.type ? (l += " margin: -", l += n(o / 2), l += "px 0 0 -", l += n(i / 2), l += "px; ") : (l += " margin-left: -", l += n(i / 2), l += "px; "), l += " ", 
			2 === r.type ? (l += " top: ", l += n(r.value), l += "px; ") : 3 === r.type ? (l += " bottom: ", l += n(r.value), l += "px; ") : l += " top: 50%; ", l += " left: 50%; display: none; z-index: 2147483647; width: ", 
			l += n(i), l += "px; height: ", l += n(o), l += "px; cursor: pointer; ", 1 === a && (l += " border-radius: 8px; box-shadow: 0 4px 12px 0 rgba(238, 238, 238, .5); "), l += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE { position: absolute; right: -20px; top: -20px; width: 40px; height: 40px; ", 
			l += "round" === s || "call" === s ? " background-position: -12px -492px; " : " background-position: 0 -260px; ", l += " } #MEIQIA-INVITE #MEIQIA-INVITE-CLOSE:active { ", 
			l += "round" === s || "call" === s ? " background-position: -12px -556px; " : " background-position: 0 -300px; ", l += " } ",
			new I(l)
			...
			var e = this,
				...
				s = (t.v, t.k, "");
			return s += "#MEIQIA-INVITE, #MEIQIA-INVITE div, #MEIQIA-INVITE img, #MEIQIA-INVITE a { float: none; width: auto; height: auto; padding: 0; margin: 0; border: 0; background: none; } #MEIQIA-INVITE { display: none; position: fixed; ",
			1 === n.type ? (s += " margin: -", s += i(o.height / 2), s += "px 0 0 -", s += i(o.width / 2), s += "px; ") : (s += " margin-left: -", s += i(o.width / 2), s += "px; "), 
			s += " ", 2 === n.type ? (s += " top: ", s += i(n.value), s += "px; ") : 3 === n.type ? (s += " bottom: ", s += i(n.value), s += "px; ") : s += " top: 50%; ", s += " left: 50%; z-index: 2147483647; width: ", 
			s += i(o.width), s += "px; height: ", s += i(o.height), s += "px; } #MEIQIA-INVITE #MEIQIA-INVITE-BG { position: absolute; top: 0; left: 0; z-index: 1; width: 100%; height: 100%; } #MEIQIA-INVITE #MEIQIA-INVITE-ACTIONS { position: relative; top: 0; left: 0; z-index: 2; width: 100%; height: 100%; } ", 
			r(a, function(t, e) {
				s += " #MEIQIA-INVITE #MEIQIA-INVITE-ACTION-", s += i(e), s += " { display: block; position: absolute; top: ", s += i(t.position.top), s += "px; left: ", s += i(t.position.left), s += "px; width: ", 
				s += i(t.width), s += "px; height: ", s += i(t.height), s += "px; cursor: pointer; } "
			}), s += " ", new I(s)
			...
			var e = this,
				...
				i = e.$escape,
				o = "";
			return o += "#MEIQIA-PANEL-HOLDER { position: fixed; ", "left" === n.type ? (o += " bottom: ", o += i(n.bottom), o += "px; left: ", o += i(n.horizontal), o += "px; ") : "right" === n.type ? 
					(o += " bottom: ", o += i(n.bottom), o += "px; right: ", o += i(n.horizontal), o += "px; ") : o += " top: 50%; left: 50%; ", o += " z-index: -1; width: 688px; height: 540px; padding: 0; ",
					o += "center" === n.type ? " margin: -270px 0 0 -344px; " : " margin: 0; ", o += " overflow: hidden; visibility: hidden; box-shadow: 0 0 20px 0 rgba(0, 0, 0, .15); border: 1px solid #eee\\0; *border: 1px solid #eee; }
						#MEIQIA-IFRAME { display: none; float: none; position: absolute; top: 0; right: 0; bottom: 0; left: 0; z-index: 1; width: 100% !important; height: 100% !important; padding: 0; margin: 0; border: 0; background: none; } 
						#MEIQIA-DRAG-HANDLE { float: none; position: absolute; top: 0; left: 0; right: 140px; z-index: 3; width: auto; height: 60px; border: 0; padding: 0; margin: 0; background: none; cursor:move; }
						#MEIQIA-DRAG-MASK { display: none; float: none; position: absolute; top: 0; left: 0; z-index: 2; width: 100%; height: 100%; padding: 0; margin: 0; border: 0; background: none; } ", 
						new I(o)
			...
			var e = this,
				...
				i = e.$escape,
				o = "";
			return o += "#MEIQIA-PANEL-HOLDER { position: fixed; bottom: 0; ", "left" === n.type ? (o += " left: ", o += i(n.horizontal), o += "px; ") : (o += " right: ", o += i(n.horizontal), o += "px; "), 
			...
			var e = this,
				...
				i = e.$escape,
				o = "";
			return o += "#MEIQIA-PANEL-HOLDER { position: fixed; ", "left" === n.type ? (o += " bottom: ", o += i(n.bottom), o += "px; left: ", o += i(n.horizontal), o += "px; ") : "right" === n.type ? (o += " bottom: ",
					o += i(n.bottom), o += "px; right: ", o += i(n.horizontal), o += "px; ") : o += " top: 50%; left: 50%; ", o += " z-index: -1; width: 688px; height: 540px; padding: 0; ", 
					o += "center" === n.type ? " margin: -270px 0 0 -344px; " : " margin: 0; ", o += " overflow: hidden; visibility: hidden; box-shadow: 0 0 20px 0 rgba(0, 0, 0, .15); border: 1px solid #eee\\0; *border: 1px solid #eee; } 
						#MEIQIA-IFRAME { display: none; float: none; position: absolute; top: 0; right: 0; bottom: 0; left: 0; z-index: 1; width: 100% !important; height: 100% !important; padding: 0; margin: 0; border: 0; background: none; } 
						#MEIQIA-DRAG-HANDLE { float: none; position: absolute; top: 0; left: 0; right: 140px; z-index: 3; width: auto; height: 60px; border: 0; padding: 0; margin: 0; background: none; cursor:move; }
						#MEIQIA-DRAG-MASK { display: none; float: none; position: absolute; top: 0; left: 0; z-index: 2; width: 100%; height: 100%; padding: 0; margin: 0; border: 0; background: none; } ", 
			...
			var e = this,
				n = (e.$helpers, t.ucPlan),
				i = "";
			return i += n ? " .MEIQIA-FULL-HTML, .MEIQIA-FULL-BODY { width: 100% !important; height: 100% !important; padding: 0 !important; margin: 0 !important; } .MEIQIA-FULL-BODY >*{ display: none !important; } .MEIQIA-FULL-BODY #MEIQIA-PANEL-HOLDER { display: block !important; } #MEIQIA-PANEL-HOLDER { width: 100%; height: 100%; overflow: hidden; background: transparent; border: 0; } #MEIQIA-IFRAME { display: none; float: none; width: 100%; height: 100%; padding: 0; margin: 0; border: 0; background: none; } " 
						: " .MEIQIA-FULL-HTML { position: static !important; width: 100% !important; height: 100% !important; overflow: visible !important; } .MEIQIA-FULL-BODY { position: fixed !important; top: 0 !important; right: 0 !important; bottom: 0 !important; left: 0 !important; width: 100% !important; height: 100% !important; padding: 0 !important; margin: 0 !important; overflow: hidden !important; } #MEIQIA-PANEL-HOLDER { display: block; position: absolute; top: 0; right: 0; bottom: 0; left: 0; z-index: -1; width: 100%; height: 100%; padding: 0; margin: 0; border: 0; overflow: hidden; visibility: hidden; opacity: 1; background: transparent; } #MEIQIA-IFRAME { display: none; position: relative; float: none; width: 100% !important; height: 100% !important; padding: 0; margin: 0; border: 0; background: none; } ",
						i += " ", new I(i)
		})
	}()
	...
	e["default"] = function(t) {
		...
		if ("init" === t) {
			...
			if (n) {
				...
				r["default"].viewport = -1 !== i.indexOf("width=device-width") && -1 !== i.indexOf("initial-scale=1.0") 
						&& -1 !== i.indexOf("minimum-scale=1.0") && -1 !== i.indexOf("maximum-scale=1.0") && -1 !== i.indexOf("user-scalable=no") ? "same" : i
			}
		} else if ("set" === t) if (r["default"].viewport)"same" !== r["default"].viewport && document.getElementsByName("viewport")[0].setAttribute("content", e);
		else {
			var o = document.createElement("meta");
			o.name = "viewport", o.content = e, document.getElementsByTagName("head")[0].appendChild(o)
		} else r["default"].viewport ? "same" !== r["default"].viewport && document.getElementsByName("viewport")[0].setAttribute("content", r["default"].viewport) : 
				document.getElementsByName("viewport")[0].parentElement.removeChild(document.getElementsByName("viewport")[0])
	}
}, function(t, e, n) {
	"use strict";
	...
	e["default"] = function() {
		...
		i = "zh" !== I["default"].language && I["default"].language
			? r["default"].widget + "/mobile-" + n.mobile.panel.type + "-" + I["default"].language + ".html?" + r["default"].tail
			: r["default"].widget + "/mobile-" + n.mobile.panel.type + ".html?" + r["default"].tail;
		...
		}) : (i = s["default"].isIE(6) || s["default"].isIE(7) || s["default"].isIE(8) || s["default"].isIE(9) ? "zh" !== I["default"].language 
			&& I["default"].language ? r["default"].widget + "/desktop-" + n.desktop.panel.type + "-basic-" + I["default"].language + ".html?" + r["default"].tail 
			: r["default"].widget + "/desktop-" + n.desktop.panel.type + "-basic.html?" + r["default"].tail : "zh" !== I["default"].language
			&& I["default"].language 
			? r["default"].widget + "/desktop-" + n.desktop.panel.type + "-" + I["default"].language + ".html?" + r["default"].tail 
			: r["default"].widget + "/desktop-" + n.desktop.panel.type + ".html?" + r["default"].tail, 
			o = "panel-desktop-" + n.desktop.panel.type, a = "panel-desktop-" + n.desktop.panel.type + "-css", l = n.desktop.panel.position);
		var d = f["default"](o, {
			pageSrc: i
		}),
			h = f["default"](a, {
		...
		u["default"](h, "MEIQIA-PANEL-STYLE"), t.innerHTML = d, document.body.appendChild(t), 
		-1 !== ["mondeo", "customer"].indexOf(n.desktop.panel.type) && p["default"]("desktop", t, document.getElementById("MEIQIA-DRAG-HANDLE"), document.getElementById("MEIQIA-DRAG-MASK"))
	}
}, function(t, e) {
	"use strict";
	Object.defineProperty(e, "__esModule", {
	...
	e["default"] = function(t) {
		...
		if (e) {
			...
			if ("hide" === t) r["default"].isMobile() ? (m["default"]("revert"), s["default"].removeClass(document.documentElement, "MEIQIA-FULL-HTML"), 
				s["default"].removeClass(document.body, "MEIQIA-FULL-BODY"), "bottom" !== u["default"].initData.widget_settings.mobile.btn.type || u["default"].withoutBtn || s["default"].addClass(document.body, "BODY-FOR-MEIQIA"), 
				document.body.scrollTop = u["default"].scrollTop) : "edge" === u["default"].initData.widget_settings.desktop.panel.type && (s["default"].removeClass(document.documentElement, "MEIQIA-FULL-HEIGHT"), 
				s["default"].removeClass(document.body, "MEIQIA-FULL-HEIGHT")), e.style.zIndex = -1, r["default"].isMobile() ? (e.style.left = "-9999px", r["default"].isThisDevice("ucbrowser") 
				&& (e.style.display = "none")) : (e.style.visibility = "hidden", n.style.display = "none"), 
				u["default"].messenger.targets.iframe1.send("panelVisibility^@#invisible"), u["default"].panelVisibility = "invisible", p["default"]("invisible");
			else {
				var i = {
					action: "remove"
				};
				if (u["default"].messenger.targets.iframe1.send("handleUnread^@#" + JSON.stringify(i)), 
					f["default"]("hasBeenRead"), clearTimeout(window._MEIQIA_INVITATION_TIMEOUT), 
					r["default"].isMobile() ? (u["default"].scrollTop = document.body.scrollTop, 
					m["default"]("set"), "bottom" !== u["default"].initData.widget_settings.mobile.btn.type || 
					u["default"].withoutBtn || s["default"].removeClass(document.body, "BODY-FOR-MEIQIA"), 
					s["default"].addClass(document.documentElement, "MEIQIA-FULL-HTML"), 
					s["default"].addClass(document.body, "MEIQIA-FULL-BODY")) : "edge" === u["default"].initData.widget_settings.desktop.panel.type && (s["default"].addClass(document.documentElement, "MEIQIA-FULL-HEIGHT"), 
					s["default"].addClass(document.body, "MEIQIA-FULL-HEIGHT")), e.style.visibility = "visible", 
					e.style.zIndex = 2147483647, r["default"].isThisDevice("android") && r["default"].isThisDevice("baiduboxapp")) {
					var o = Math.max.apply(null, Array.prototype.map.call(document.querySelectorAll("*"), function(t) {
						return 2147483647 === +t.style.zIndex ? 999999998 : +t.style.zIndex
					}));
					e.style.zIndex = o + 1
				}
				n.style.display = "block", r["default"].isMobile() && e.style.left && (e.style.left = ""), 
				u["default"].messenger.targets.iframe1.send("panelVisibility^@#visible"),
				u["default"].panelVisibility = "visible",
				p["default"]("visible"), "function" != typeof u["default"].getInviting && document.getElementById("MEIQIA-INVITE") && "block" === document.getElementById("MEIQIA-INVITE").style.display && I["default"]("none")
			}
		}
	}
}, function(t, e) {
	...
	var o = n(11),
		...
		a = function s(t) {
			...
			function() {
				...
				}, 1e3 * parseInt(e.auto.reject.countdown))), "manual" === r["default"].inviteType
					&& clearTimeout(window._MEIQIA_ACCEPT_INVITE_TIMEOUT)) : "none" === t ? n.style.display = "none" : "invisible" === r["default"].panelVisibility && "no" === r["default"].conversation 
					&& ("manual" === r["default"].inviteType && "open" === e.manual.accept.status && (window._MEIQIA_ACCEPT_INVITE_TIMEOUT = setTimeout(function() {
	...
	e["default"] = function() {
		var t = r["default"].isMobile(),
			...
			d = "",
			h = "";
		t ? (I["default"].preview = i.mobile.btn.preview, "bottom" === i.mobile.btn.type && s["default"].addClass(document.body, "BODY-FOR-MEIQIA"), 
			e.servability || 4 === e.visitor_status ? (c = "CHAT" + i.mobile.btn.icon.online, d = i.mobile.btn.text.online, h = i.mobile.btn.picture.online) : 
			(c = "TICKET" + i.mobile.btn.icon.offline, d = i.mobile.btn.text.offline, h = i.mobile.btn.picture.offline), a = f["default"]("btn-mobile-" + i.mobile.btn.type + "-css", {
			...
			btnText: d,
			btnSrc: h
		})) : (I["default"].preview = i.desktop.btn.preview, e.servability || 4 === e.visitor_status ? 
			(c = "CHAT" + i.desktop.btn.icon.online, d = i.desktop.btn.text.online, h = i.desktop.btn.picture.online) : 
			(c = "TICKET" + i.desktop.btn.icon.offline, d = i.desktop.btn.text.offline, h = i.desktop.btn.picture.offline), 
			a = f["default"]("btn-desktop-" + i.desktop.btn.type + "-css", {
		...
		var g = 0;
		t ? "call" === i.mobile.btn.type && (g = 1) : "call" === i.desktop.btn.type && (g = 1), E(g), t && "round" === i.mobile.btn.type && p["default"]("mobile", document.getElementById("MEIQIA-BTN-HOLDER"), 
		document.getElementById("MEIQIA-BTN"))
	}
}, function(t, e, n) {
	"use strict";
	...
	function o(t, e, n) {
		return window.open(e ? "https://static.meiqia.com/dist/standalone.html?eid=" + t + "&agentid=" + e : n ? "https://static.meiqia.com/dist/standalone.html?eid=" + t + "&groupid=" + n : "https://static.meiqia.com/dist/standalone.html?eid=" + t),
		"callwidget"
	}
	Object.defineProperty(e, "__esModule", {
		value: !0
		...
		x = function(t, e) {
			...
			var b = function() {
					...
					n.id = "MEIQIA-INVITE", n.innerHTML = l, document.body.appendChild(n), m["default"].inviteReady = !0, 6 === o ? document.getElementById("MEIQIA-INVITE").addEventListener("click", function(t) {
						if ("meiqiaInviteReject" === t.target.name && (p["default"].set("MEIQIA_REJECT_INVITATION", "yes"), v["default"]("hide"), clearTimeout(window._MEIQIA_AUTO_ACCEPT_INVITATION_TIMEOUT), 
						m["default"].messenger.targets.iframe1.send("rejectInvitation^@#")), "meiqiaInviteAccept" === t.target.name) {
							if (m["default"].assign && (m["default"].assign.agentToken && (g.agentToken = m["default"].assign.agentToken), m["default"].assign.groupToken && (g.groupToken = m["default"].assign.groupToken)), 
							"manual" === m["default"].inviteType && (g.type = "manualInvite", g.agentToken = m["default"].agentToken, g.groupToken = null), "callwidget" === E["default"](m["default"])) return;
						...
						if ("MEIQIA-INVITE-CLOSE" === t.target.id) p["default"].set("MEIQIA_REJECT_INVITATION", "yes"), v["default"]("hide"), clearTimeout(window._MEIQIA_AUTO_ACCEPT_INVITATION_TIMEOUT), 
						m["default"].messenger.targets.iframe1.send("rejectInvitation^@#");
						else {
							if (m["default"].assign && (m["default"].assign.agentToken && (g.agentToken = m["default"].assign.agentToken), m["default"].assign.groupToken &&
							(g.groupToken = m["default"].assign.groupToken)), "manual" === m["default"].inviteType && (g.type = "manualInvite", g.agentToken = m["default"].agentToken, g.groupToken = null), 
							"callwidget" === E["default"](m["default"])) return;
							m["default"].messenger.targets.iframe1.send("callWidget^@#" + JSON.stringify(g))
						}
					}), t.servability && (2 === t.visitor_status ? (m["default"].agentToken = t.visitor_status_agent_token, m["default"].inviteType = "manual", v["default"]()) : 4 !== t.visitor_status && 
					"open" === e.auto.status && (clearTimeout(window._MEIQIA_INVITATION_TIMEOUT), window._MEIQIA_INVITATION_TIMEOUT = setTimeout(function() {
						m["default"].inviteType = "auto", v["default"](), clearTimeout(window._MEIQIA_AUTO_ACCEPT_INVITATION_TIMEOUT), "open" === e.auto.accept.status && (window._MEIQIA_AUTO_ACCEPT_INVITATION_TIMEOUT = setTimeout(function() {
							"no" === m["default"].conversation && (g.type = "autoInvite", m["default"].assign && (m["default"].assign.agentToken && (g.agentToken = m["default"].assign.agentToken), 
							m["default"].assign.groupToken && (g.groupToken = m["default"].assign.groupToken)), m["default"].messenger.targets.iframe1.send("callWidget^@#" + JSON.stringify(g)))
						}, 1e3 * parseInt(e.auto.accept.countdown)))
	...
	e["default"] = function() {
		...
		"open" === e.facade_status ? f["default"].ajax({
			...
			success: function(n) {
				n.look_config && (e.mobile = n.look_config.mobile, e.desktop = n.look_config.desktop), n.mech_config && (e.auto = n.mech_config.auto, e.manual = n.mech_config.manual), x(t, e)
			},
			error: function(t) {
				console.log("err", t)
			}
	...
	function(t) {
		...
		return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
	}, r = n(10), a = i(r), s = n(11), l = i(s), u = n(14), c = i(u), p = n(24), d = i(p), f = n(25), h = i(f), I = n(41), g = i(I), m = n(33), b = i(m), E = n(43), y = i(E), v = n(31), x = i(v), _ = n(16), A = i(_);
	e["default"] = function() {
			...
			if ("object" === ("undefined" == typeof t ? "undefined" : o(t)) && t.length) {
				...
				case "showPanel":
					if (l["default"].chatReady) {
						if ("callwidget" === x["default"](l["default"])) return;
						var i = "callWidget^@#";
						n = "object" === ("undefined" == typeof n ? "undefined" : o(n)) ? n : l["default"].assign,
						n ? n.agentToken && (n.groupToken = null) : n = {}, n.type = "click", i += JSON.stringify(n), l["default"].messenger.targets.iframe1.send(i)
	...
	function i(t, e) {
		if (a[t] = !0, r[t]) for (var n = void 0; n = r[t].shift();) n.apply(null, e || [])
	}
	function o(t) {
		delete a[t]
	}
	...
	(function(e) {
		...
		t.exports = function() {
			...
			function r(t) {
				t !== v && o(this, t), this._bitField = 0, this._fulfillmentHandler0 = void 0,
				this._rejectionHandler0 = void 0, this._promise0 = void 0, this._receiver0 = void 0, this._resolveFromExecutor(t), this._promiseCreated(), this._fireEvent("promiseCreated", this)
			}
			function a(t) {
			...
			return r.prototype.toString = function() {
				...
				if (e > 1) {
					...
					return i.length = o, t = arguments[n], this.then(void 0, N(i, t, this))
				}
				...
				return "function" != typeof t ? d("expecting a function but got " + h.classString(t)) : this.all()._then(t, void 0, void 0, x, void 0)
				...
				var a = void 0 !== o,
					...
					l = this._target(),
					c = l._bitField;
				a || (s._propagateFrom(this, 3), s._captureStackTrace(), 
				void 0 === i && 0 !== (2097152 & this._bitField) && (i = 0 !== (50397184 & c) ? this._boundValue() : l === this ? void 0 : this._boundTo), this._fireEvent("promiseChained", this, s));
				var p = u();
				if (0 !== (50397184 & c)) {
					var d, f, I = l._settlePromiseCtx;
					0 !== (33554432 & c) ? (f = l._rejectionHandler0, d = t) : 0 !== (16777216 & c) ? 
					(f = l._fulfillmentHandler0, d = e, l._unsetRejectionIsUnhandled()) : (I = l._settlePromiseLateCancellationObserver, 
						f = new y("late cancellation observer"), l._attachExtraTrace(f), d = e), m.invoke(I, l, {
				...
				var r = this._length();
				if (r >= 65531 && (r = 0, this._setLength(0)), 0 === r) this._promise0 = n, this._receiver0 = i, 
				"function" == typeof t && (this._fulfillmentHandler0 = null === o ? t : h.domainBind(o, t)), "function" == typeof e && (this._rejectionHandler0 = null === o ? e : h.domainBind(o, e));
				else {
					var a = 4 * r - 4;
				...
				if (0 === (65536 & o)) {
					i._pushContext();
					var r;
					e === x ? n && "number" == typeof n.length ? r = O(t).apply(this._boundValue(), n) : (r = C, r.e = new E("cannot .spread() a non-array: " + h.classString(n))) : r = O(t).call(e, n);
					var a = i._popContext();
					o = i._bitField, 0 === (65536 & o) && (r === _ ? i._reject(n) : r === C ? i._rejectCallback(r.e, !1) : (B.checkForgottenReturns(r, a, "", i, this), i._resolveCallback(r)))
				}
				...
				var a = t instanceof r,
					s = this._bitField,
					l = 0 !== (134217728 & s);
				0 !== (65536 & s) ? (a && t._invokeInternalOnCancel(), n instanceof Q && n.isFinallyHandler() ? 
				(n.cancelPromise = t, O(e).call(n, o) === C && t._reject(C.e)) : e === p ? t._fulfill(p.call(n)) : n instanceof i ? 
				n._promiseCancelled(t) : a || t instanceof T ? t._cancel() : n.cancel()) : "function" == typeof e ? a ? 
				(l && t._setAsyncGuaranteed(), this._settlePromiseFromHandler(e, n, o, t)) : e.call(n, o, t) : n instanceof i ? 
				n._isResolved() || (0 !== (33554432 & s) ? n._promiseFulfilled(o, t) : n._promiseRejected(o, t)) : a && 
				(l && t._setAsyncGuaranteed(), 0 !== (33554432 & s) ? t._fulfill(o) : t._reject(o))
				...
				this._fulfillmentHandler0 = t, this._isFinal() ? m.fatalError(t, h.isNode) : void((65535 & e) > 0 ? m.settlePromises(this) : this._ensurePossibleRejectionHandled())
			...
			}, h.notEnumerableProp(r, "_makeSelfResolutionError", c), n(65)(r, v, A, d, B), 
			n(66)(r, v, A, B), n(67)(r, T, d, B), n(68)(r), n(69)(r), n(70)(r, T, A, v, m, u), 
			r.Promise = r, r.version = "3.5.1", n(71)(r, T, d, A, v, B), n(72)(r), n(73)(r, d, A, w, v, B), n(74)(r, v, B), n(75)(r, d, v, A, i, B), n(76)(r), n(77)(r, v), n(78)(r, T, A, d), n(79)(r, v, A, d), 
			n(80)(r, T, d, A, v, B), n(81)(r, T, B), n(82)(r, T, d), n(83)(r, v), n(84)(r, v), 
			n(85)(r), h.toFastProperties(r), h.toFastProperties(r.prototype), l({
				a: 1
			}), l({
				b: 2
			}), l({
	...
	d.nextTick = function(t) {
		...
		d.removeAllListeners = u, d.emit = u, d.binding = function(t) {
	...
	(function(e, i) {
		...
		function o() {
			try {
				var t = k;
				return k = null, t.apply(this, arguments)
			} catch (e) {
				return N.e = e, N
			}
		}
		...
		function(t) {
			...
			return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
		}, B = n(52), Q = "undefined" == typeof navigator, N = {
			e: {}
		}, k, C = "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof e ? e : null, O = function(t, e) {
			function n() {
			...
			return function(n) {
				if (e(n)) return [];
				var o = [];
				t: for (var r in n) if (i.call(n, r)) o.push(r);
				else {
					for (var a = 0; a < t.length; ++a) if (i.call(t[a], r)) continue t;
					o.push(r)
				}
				return o
			}
		}(), S = /this\s*\.\s*\S+\s*=/, R = /^[a-z$_][a-z$_0-9]*$/i, j = function() {
		...
		if ("undefined" != typeof Symbol && Symbol.iterator) {
			var U = "function" == typeof Array.from ?
			function(t) {
				return Array.from(t)
			} : function(t) {
		...
		var P = "undefined" != typeof i && "[object process]" === x(i).toLowerCase(),
	...
	(function(e, i, o) {
		...
		} else r = "undefined" == typeof MutationObserver || "undefined" != typeof window && window.navigator && (window.navigator.standalone || window.cordova) ? "undefined" != typeof o ?
		function(t) {
			o(t)
	...
	function o(t) {
		...
		p(this, "message", t), this.cause = t, this.isOperational = !0, void(t instanceof Error ? (p(this, "message", t.message),
	...
	for (var m = "join pop push shift unshift slice filter forEach some every map indexOf lastIndexOf reduce reduceRight sort reverse".split(" "),
	b = 0; b < m.length; ++b)"function" == typeof Array.prototype[m[b]] && (I.prototype[m[b]] = Array.prototype[m[b]]);
	...
	t.exports = function(t, e, i, o, r) {
		...
		return l.inherits(s, r), s.prototype.length = function() {
			...
			for (var o = this._promise, r = !1, a = null, s = 0; n > s; ++s) {
				var l = i(e[s], o);
				l instanceof t ? (l = l._target(), a = l._bitField) : a = null, r ? null !== a && l.suppressUnhandledRejections() : null !== a ? 0 === (50397184 & a) ? (l._proxy(this, s), 
				this._values[s] = l) : r = 0 !== (33554432 & a) ? this._promiseFulfilled(l._value(), s) : 0 !== (16777216 & a) ? this._promiseRejected(l._reason(), s) : this._promiseCancelled(s) : r = this._promiseFulfilled(l, s)
			}
		...
		t.exports = function(t, o) {
			...
			function m(t, e, n, i, o) {
				if (void 0 === t && null !== e && X) {
					...
					if (e._trace) {
						...
						if (l.length > 0) for (var d = l[0], u = 0; u < s.length; ++u) if (s[u] === d) {
							u > 0 && (a = "\n" + s[u - 1]);
							break
						}
					}
			...
			function x(t) {
				for (var e = t[0], n = 1; n < t.length; ++n) {
					for (var i = t[n], o = e.length - 1, r = e[o], a = -1, s = i.length - 1; s >= 0; --s) if (i[s] === r) {
						a = s;
						break
					}
					for (var s = a; s >= 0; --s) {
			...
			function T(t) {
				...
				return e = "string" == typeof e && e.length > 0 ? A(t) : ["    (No stack trace)"], {
					message: n,
					stack: "SyntaxError" == t.name ? e : _(e)
				}
			}
			function M(t, e, n) {
				if ("undefined" != typeof console) {
					...
					"function" == typeof R ? R(o, n) : ("function" == typeof console.log || "object" === i(console.log)) && console.log(o)
				}
			}
			function w(t, e, n, i) {
				var o = !1;
			...
			t.longStackTraces = function() {
				...
				return st.longStackTraces && N()
			};
			var Z = function() {
					try {
						if ("function" == typeof CustomEvent) {
							var t = new CustomEvent("CustomEvent");
							return P.global.dispatchEvent(t), function(t, e) {
						...
						return t.initCustomEvent("testingtheevent", !1, !0, {}), P.global.dispatchEvent(t), function(t, e) {
			...
			}, t.prototype._onCancel = function() {}, t.prototype._setOnCancel = function(t) {}, 
			...
			P.inherits(O, Error), o.CapturedTrace = O, O.prototype.uncycle = function() {
				...
				if (!t.__stackCleaned__) {
					this.uncycle();
					for (var e = T(t), n = e.message, i = [e.stack], o = this; void 0 !== o;) i.push(_(o.stack.split("\n"))), o = o._parent;
					x(i), v(i), P.notEnumerableProp(t, "stack", y(n, i)), P.notEnumerableProp(t, "__stackCleaned__", !0)
				}
			};
			var at = function() {
					var t = /^\s*at\s*/,
					...
					var o = new Error;
					if ("string" == typeof o.stack && o.stack.split("\n")[0].indexOf("stackDetection@") >= 0) return $ = /@/, W = e, G = !0, function(t) {
			...
			"undefined" != typeof console && "undefined" != typeof console.warn && (R = function(t) {
				console.warn(t)
			}, P.isNode && e.stderr.isTTY ? R = function(t, e) {
				var n = e ? "[33m" : "[31m";
				console.warn(n + t + "[0m\n")
			} : P.isNode || "string" != typeof(new Error).stack || (R = function(t, e) {
	...
	t.exports = function(t, e, i, o) {
		...
		t.prototype["break"] = t.prototype.cancel = function() {
			...
			if (r.isArray(t)) for (var n = 0; n < t.length; ++n) this._doInvokeOnCancel(t[n], e);
	...
	t.exports = function(t, e, i, o, r, a) {
		...
		if (u) {
			for (var d = function(t) {
					...
					return u = u.replace(/\[TheName\]/g, l).replace(/\[TheTotal\]/g, e).replace(/\[ThePassedArguments\]/g, s).replace(/\[TheProperties\]/g, o).replace(/\[CancellationCode\]/g, a), 
					new Function("tryCatch", "errorObj", "Promise", "async", u)(c, p, t, r)
		...
		t.join = function() {
			...
			for (var v = arguments.length, x = new Array(v), _ = 0; v > _; ++_) x[_] = arguments[_];
			n && x.pop();
			var c = new e(x).promise();
	...
	t.exports = function(t, e, i, o, r, a) {
		...
		c.prototype.data = function() {
			...
			var v = t.all(y).then(function(t) {
				...
				x._pushContext(), o = b(o);
				var i = s ? o.apply(void 0, t) : o(t),
					r = x._popContext();
				return a.checkForgottenReturns(i, r, "Promise.using", x), i
			}),
				x = v.lastly(function() {
					var e = new t.PromiseInspection(v);
					return u(l, e)
				});
			return l.promise = x, x._setOnCancel(l), x
	...
	t.exports = function(t, e, i, o, r, a) {
		...
		p.inherits(l, r), l.prototype._isResolved = function() {
			...
			if (!(r instanceof t) && (r = s(r, this._yieldHandlers, this._promise), null === r)) 
			return void this._promiseRejected(new c("A value %s was yielded that could not be treated as a promise\n\n    See http://goo.gl/MqrFmX\n\n".replace("%s", String(i)) + "From coroutine:\n" + this._stack.split("\n").slice(1, -7).join("\n")));
			r = r._target();
			var a = r._bitField;
			0 === (50397184 & a) ? (this._yieldedPromise = r, r._proxy(this, null)) : 0 !== (33554432 & a) ?
			t._async.invoke(this._promiseFulfilled, this, r._value()) : 0 !== (16777216 & a) ?
			t._async.invoke(this._promiseRejected, this, r._reason()) : this._promiseCancelled()
	...
	t.exports = function(t, e) {
		...
		function s(t, e, n) {
			for (var i = 0; i < t.length; i += 2) {
				var o = t[i];
				if (n.test(o)) for (var r = o.replace(n, ""), a = 0; a < t.length; a += 2) if (t[a] === r) throw new E("Cannot promisify an API that has normal methods with '%s'-suffix\n\n    See http://goo.gl/MqrFmX\n".replace("%s", e))
			}
		}
		function l(t, e, n, i) {
		...
		function c(t, e, n, i, o) {
			for (var r = new RegExp(T(e) + "$"), a = l(t, e, r, n), s = 0, u = a.length; u > s; s += 2) {
				var c = a[s],
					p = a[s + 1],
					d = c + e;
				if (i === N) t[d] = N(c, f, c, p, e, o);
				else {
					var I = i(p, function() {
						return N(c, f, c, p, e, o)
					});
		...
		var d, f = {},
			...
			x = ["arity", "length", "name", "arguments", "caller", "callee", "prototype", "__isPromisified__"],
			_ = new RegExp("^(?:" + x.join("|") + ")$"),
			A = function(t) {
		...
		d = function(n, i, o, r, a, s) {
			...
			return E = E.replace("Parameters", B(c)), new Function("Promise", "fn", "receiver", "withAppended", "maybeWrapAsError", "nodebackForPromise", "tryCatch", "errorObj", "notEnumerableProp", "INTERNAL", E)
			(t, r, i, g, m, I, h.tryCatch, h.errorObj, h.notEnumerableProp, e)
		};
		var N = b ? d : u;
		t.promisify = function(t, e) {
			...
			var a = e.promisifier;
			if ("function" != typeof a && (a = N), !h.isIdentifier(o)) throw new RangeError("suffix must be a valid identifier\n\n    See http://goo.gl/MqrFmX\n");
	...
	t.exports = function(t, e, i, o, r, a) {
		function s(e, n, i, o) {
			this.constructor$(e);
			var a = d();
			this._fn = null === a ? n : f.domainBind(a, n), void 0 !== i && (i = t.resolve(i), i._attachCancellationCallback(this)), 
			this._initialValue = i, this._currentCancellable = null, this._eachValues = o === r ? Array(this._length) : 0 === o ? null : void 0, this._promise._captureStackTrace(), this._init$(void 0, -5)
		}
		function l(t, e) {
		...
		f.inherits(s, e), s.prototype._gotAccum = function(t) {
			...
			return e === this._initialValue ? this._cancel() : void(this._isResolved() ||
			(this._resultCancelled$(), this._currentCancellable instanceof t &&
			this._currentCancellable.cancel(), this._initialValue instanceof t && this._initialValue.cancel()))
		}, s.prototype._iterate = function(e) {
			this._values = e;
			var n, i, o = e.length;
			if (void 0 !== this._initialValue ? (n = this._initialValue, i = 0) : (n = t.resolve(e[0]), i = 1), this._currentCancellable = n, !n.isRejected()) for (; o > i; ++i) {
				var r = {
					accum: null,
					value: e[i],
					index: i,
	...
	function o() {
		...
		p["default"](d, "MEIQIA-ICON-STYLE"), 
		E["default"](), T(), t && "round" === n.mobile.btn.type && 
		f["default"]("mobile", document.getElementById("MEIQIA-BTN-HOLDER"), document.getElementById("MEIQIA-BTN")), m["default"].renderFakeBtn = !0
	}
	Object.defineProperty(e, "__esModule", {
		value: !0
	}), e["default"] = o;
	var r = n(15),
		...
		T = function(t) {
			document.getElementById("MEIQIA-BTN").addEventListener("click", function(t) {
				_["default"](), m["default"].renderFakeBtn = !1, v["default"](), window._MEIQIA("allSet", function() {
					window._MEIQIA("showPanel")
				})
			})
		}
