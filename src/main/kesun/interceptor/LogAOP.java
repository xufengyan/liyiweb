...
public class LogAOP {
     ...
     * @param joinPoint
     */
    @Before(value="declearJoinPointExpression()") //该标签声明次方法是一个前置通知：在目标方法开始之前执行
     ...
     * @param joinPoint
     */
    @After(value="declearJoinPointExpression()")
