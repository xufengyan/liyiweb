...
import kesun.controller.KesunSuperController;
...
public class SystemMenuController extends SuperController implements kesun.controller.system.ISystemMenu {
    ...
    @ResponseBody
    public Object saveAll(@RequestBody SystemMenu model) {
        ReturnBean rb=new ReturnBean();
        rb.setMessage("菜单自动批量操作");
        getService().setModel(model);
        rb.setCode(Integer.toString(((SystemMenuServiceImpl)getService()).savaAll()));
        return rb;
    }
}
