...
import kesun.bll.liyi.impl.yh_RefundService;
...
@Controller
@RequestMapping("yh_refund")
public class yh_RefundController extends SuperController {

    @Resource(name = "byh_refund")
    private yh_RefundService bll;
