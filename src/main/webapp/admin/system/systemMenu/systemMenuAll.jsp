...
<form class="layui-form" id="ff">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">模块级编号：</label>
        <div class="layui-input-block">
            <input type="text" name="id" required  lay-verify="required" placeholder="请输入4位模块编号" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">模块名称：</label>
        <div class="layui-input-block">
            <input type="text" name="name" required  lay-verify="required" placeholder="请输入模块功能名称" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">模块地址：</label>
        <div class="layui-input-block">
            <input type="text" name="address" required  lay-verify="required" placeholder="请输入系统功能功能请求根地址" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(formDemo)', function(data){
            ...
            kb.do("saveAll",obj,function (data) {
                 layer.msg(data.code);
             });
