...
<form class="layui-form" id="ff">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="id"  autocomplete="off" placeholder="请输入高校的编号，要求5位以内的数字" class="layui-input" type="text" maxlength="5">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">礼品名字：</label>
        <div class="layui-input-block">
            <input name="commname" required  lay-verify="required" autocomplete="off" placeholder="请输入高校名称" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <%--<div class="layui-form-item">--%>
        ...
        <%--<div class="layui-input-block">--%>
            <%--<textarea id="description" name="description"  placeholder="请填写简介信息(500字以内)" style="display: none;" maxlength="500"></textarea>--%>
        <%--</div>--%>
    <%--</div>--%>
    ...
    <div class="layui-form-item" id="dButton">
        <div class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="formDemo" onclick="daa()">提交</button>
