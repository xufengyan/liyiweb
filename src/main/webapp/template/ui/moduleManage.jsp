...
<table class="easyui-datagrid" title="【此处需要修改】" style="height:auto" id="dgCollege"
...
<!--导入数据导出-->
<form  style="display: none;"  id="frmDownloadExcel" method="post" action="<%=basePath%>/【此处需要修改，控制层模块地址】/loadout">
     <input type="hidden" id="txtHName" name="name"/>
</form>
<script src="<%=basePath%>/script/business/【此处需要修改，模块脚本】.js"></script>
